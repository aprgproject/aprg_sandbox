...
void PidSimulator::calculateAndGenerateOutputImage() {
    ...
    for (double const inputDemandSample : m_inputSample) {
        ...
        updateMaxPoints(
            static_cast<int>(index), static_cast<int>(m_conf.targetInPidCalculation), xLeftMax, xRightMax, yBottomMax,
            yTopMax);
        updateMaxPoints(
            static_cast<int>(index), static_cast<int>(inputDemandSample), xLeftMax, xRightMax, yBottomMax, yTopMax);
        updateMaxPoints(
            static_cast<int>(index), static_cast<int>(psuedoMaxTxPower), xLeftMax, xRightMax, yBottomMax, yTopMax);
        updateMaxPoints(
            static_cast<int>(index), static_cast<int>(psuedoMaxTxPower), xLeftMax, xRightMax, yBottomMax, yTopMax);
        updateMaxPoints(
            static_cast<int>(index), static_cast<int>(tcomReceivedPowerFromMachs), xLeftMax, xRightMax, yBottomMax,
            yTopMax);
        // Remove adjusted demand //updateMaxPoints(static_cast<int>(index), static_cast<int>(adjustedDemand), xLeftMax,
        // xRightMax, yBottomMax, yTopMax);

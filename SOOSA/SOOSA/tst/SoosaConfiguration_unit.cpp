...
TEST(SoosaConfigurationTest, LoadConfigurationFromFileWorks)
{
    ...
    EXPECT_DOUBLE_EQ(0.95, soosaConfiguration.getRemovalRatioForSquareErrorsInLineModel());
    EXPECT_EQ(10U, soosaConfiguration.getMinimumLineSamples());

    EXPECT_EQ(500U, soosaConfiguration.getBitmapWidthToBarWidthMultiplier());
    ...
    EXPECT_DOUBLE_EQ(0.95, soosaConfiguration.getRemovalRatioForLineAndBar());
    EXPECT_DOUBLE_EQ(0.10, soosaConfiguration.getAcceptableSdOverMeanDeviationForBarHeight());
    EXPECT_DOUBLE_EQ(0.98, soosaConfiguration.getRemovalRatioForBarHeight());

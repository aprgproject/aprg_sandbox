    ...
    if(!pointAndWidthPairs.empty())
    {
        ...
        while(needsRemoval)
        {
            ...
            if(needsRemoval)
            {
                ...
                if(firstSdOverMean > m_soosaConfiguration.getAcceptableSdOverMeanDeviationForLine())
                {
                ...
                if(secondSdOverMean > m_soosaConfiguration.getAcceptableSdOverMeanDeviationForBar())
                {

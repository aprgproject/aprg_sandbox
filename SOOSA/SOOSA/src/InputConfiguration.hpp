...
public:
    ...
    void setMainParameters(std::string const& area, std::string const& period, double const discharge, unsigned int const minimumSatisfactoryScore);    void addQuestion(unsigned int const columnNumber, std::string const& question);

...
private:
    ...
    TwoDimensions::Line findLeftLine(AprgBitmapSnippet const& snippet) const;
    TwoDimensions::Line findRightLine(AprgBitmapSnippet const& snippet) const;
    TwoDimensions::Line findTopLine(AprgBitmapSnippet const& snippet) const;
    TwoDimensions::Line findBottomLine(AprgBitmapSnippet const& snippet) const;
    TwoDimensions::Line findVerticalLine(AprgBitmapSnippet const& snippet, RangeOfInts const& range) const;
    TwoDimensions::Line findHorizontalLine(AprgBitmapSnippet const& snippet, RangeOfInts const& range) const;
    TwoDimensions::Line findLeftLineUsingStartingLine(AprgBitmapSnippet const& snippet, TwoDimensions::Line const& startingLine) const;
    TwoDimensions::Line findRightLineUsingStartingLine(AprgBitmapSnippet const& snippet, TwoDimensions::Line const& startingLine) const;
    TwoDimensions::Line findVerticalLineUsingStartingLine(AprgBitmapSnippet const& snippet, TwoDimensions::Line const& startingLine, RangeOfInts const& rangeForX) const;
    ...
    void processColumn(AprgBitmapSnippet const& snippet, TwoDimensions::Line const& leftLine, TwoDimensions::Line const& rightLine, unsigned int const columnNumber);
    ...
    bool isChoiceShaded(AprgBitmapSnippet const& snippet, TwoDimensions::Point const& leftPoint, TwoDimensions::Point const& rightPoint, unsigned int const choiceIndex, unsigned int const radius) const;
    QuestionBarCoordinates getQuestionBarCoordinatesFromLine(AprgBitmapSnippet const& snippet, TwoDimensions::Line const& line, unsigned int const numberQuestionsInColumn) const;
    ...
    TwoDimensions::Point getNearestBlackPointFromLine(AprgBitmapSnippet const& snippet, TwoDimensions::Line const& line, TwoDimensions::Point const& point) const;
    ...
    BitmapXY convertToBitmapXY(TwoDimensions::Point const& point) const;
    BitmapXY convertToBitmapXY(TwoDimensionsStatistics::Sample const& sample) const;
    TwoDimensions::Point convertToPoint(BitmapXY const& bitmapXY) const;

...
TEST(UciUtilitiesTest, RetrieveCalculationDetailsOnStringFromEngineWorksOnInfoExample1) {
    ...
    EXPECT_EQ(expectedMoveAndScorePairs, actualDetails.currentMovesAndScores);
    EXPECT_EQ(-69, actualDetails.scoreInPvLine);
    EXPECT_EQ(expectedPv, actualDetails.pvHalfMovesInMonitoredLine);
    EXPECT_TRUE(actualDetails.bestMove.empty());    EXPECT_TRUE(actualDetails.possibleResponseMove.empty());
}

TEST(UciUtilitiesTest, RetrieveCalculationDetailsOnStringFromEngineWorksOnInfoExample2) {    CalculationDetails actualDetails{};
    string stringFromEngine(
    ...
    EXPECT_EQ(expectedMoveAndScorePairs, actualDetails.currentMovesAndScores);
    EXPECT_EQ(-999999, actualDetails.scoreInPvLine);
    EXPECT_EQ(expectedPv, actualDetails.pvHalfMovesInMonitoredLine);
    EXPECT_TRUE(actualDetails.bestMove.empty());    EXPECT_TRUE(actualDetails.possibleResponseMove.empty());
}

TEST(UciUtilitiesTest, RetrieveCalculationDetailsOnStringFromEngineWorksOnInfoExample3) {    CalculationDetails actualDetails{};
    string stringFromEngine(
    ...
    EXPECT_EQ(0, actualDetails.mateScore);
    EXPECT_EQ(expectedMoveAndScorePairs, actualDetails.currentMovesAndScores);
    EXPECT_EQ(14, actualDetails.scoreInPvLine);
    EXPECT_EQ(expectedPv, actualDetails.pvHalfMovesInMonitoredLine);
    EXPECT_TRUE(actualDetails.bestMove.empty());    EXPECT_TRUE(actualDetails.possibleResponseMove.empty());
}
...
TEST(UciUtilitiesTest, RetrieveCalculationDetailsOnStringFromEngineWorksOnInfoExample4) {    CalculationDetails actualDetails{};
    ...
    EXPECT_EQ(0, actualDetails.mateScore);
    EXPECT_TRUE(actualDetails.currentMovesAndScores.empty());
    EXPECT_EQ(0, actualDetails.scoreInPvLine);
    EXPECT_TRUE(actualDetails.pvHalfMovesInMonitoredLine.empty());
    EXPECT_TRUE(actualDetails.bestMove.empty());    EXPECT_TRUE(actualDetails.possibleResponseMove.empty());
}
...
TEST(UciUtilitiesTest, RetrieveCalculationDetailsOnStringFromEngineWorksOnBestMoveExample1) {    CalculationDetails actualDetails{};
    ...
    EXPECT_EQ(0, actualDetails.scoreInPvLine);
    EXPECT_TRUE(actualDetails.pvHalfMovesInMonitoredLine.empty());
    EXPECT_EQ("b4c2", actualDetails.bestMove);    EXPECT_EQ("e1d1", actualDetails.possibleResponseMove);
}

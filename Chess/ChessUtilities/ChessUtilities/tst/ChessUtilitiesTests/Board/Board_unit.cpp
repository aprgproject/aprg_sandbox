...
TEST(BoardTest, ConstructionWorks) {
    ...
    EXPECT_EQ(BoardOrientation::WhiteUpBlackDown, boardConstructedWithOrientationAndPieceMatrix.getOrientation());
...
TEST(BoardTest, EqualOperatorWorks) {
    ...
    EXPECT_FALSE(boardWithBW.operator==(boardWithWrongOrientation));    EXPECT_FALSE(boardWithBW.operator==(boardWithOneWrongPiece));
}
...
TEST(BoardTest, NotEqualOperatorWorks) {
    ...
    EXPECT_TRUE(boardWithBW.operator!=(boardWithWrongOrientation));    EXPECT_TRUE(boardWithBW.operator!=(boardWithOneWrongPiece));
}
...
TEST(BoardTest, GetMovesFromThisWorksOnOneStepPawnNonCapture) {
    ...
    EXPECT_EQ(expectedMovesAtTheBottom, boardWithBW.getMovesFromThis({7, 7}));    EXPECT_EQ(expectedMovesAtTheBottom, boardWithWB.getMovesFromThis({7, 7}));
...
TEST(BoardTest, GetMovesFromThisWorksOnTwoStepsPawnNonCapture) {
    ...
    EXPECT_EQ(expectedMovesAtTheBottom, boardWithBW.getMovesFromThis({7, 6}));    EXPECT_EQ(expectedMovesAtTheBottom, boardWithWB.getMovesFromThis({7, 6}));
...
TEST(BoardTest, GetMovesFromThisWorksOnPawnCapture) {
    ...
    EXPECT_EQ(expectedMovesAtTheBottom, boardWithBW.getMovesFromThis({6, 6}));    EXPECT_EQ(expectedMovesAtTheBottom, boardWithWB.getMovesFromThis({6, 6}));
...
TEST(BoardTest, GetMovesFromThisWorksOnBishopMoves) {
    ...
    Moves expectedMovesAtTheTop{{{2, 2}, {1, 1}}, {{2, 2}, {0, 0}}, {{2, 2}, {1, 3}}, {{2, 2}, {3, 1}},                                {{2, 2}, {4, 0}}, {{2, 2}, {3, 3}}, {{2, 2}, {4, 4}}, {{2, 2}, {5, 5}}};
...
TEST(BoardTest, GetMovesFromThisWorksOnRookMoves) {
    ...
    Moves expectedMovesAtTheTop{{{2, 2}, {2, 1}}, {{2, 2}, {2, 0}}, {{2, 2}, {2, 3}},                                {{2, 2}, {1, 2}}, {{2, 2}, {0, 2}}, {{2, 2}, {3, 2}}};
    EXPECT_EQ(expectedMovesAtTheBottom, boardWithBW.getMovesFromThis({5, 5}));
    EXPECT_EQ(expectedMovesAtTheBottom, boardWithWB.getMovesFromThis({5, 5}));
    EXPECT_EQ(expectedMovesAtTheTop, boardWithBW.getMovesFromThis({2, 2}));
    EXPECT_EQ(expectedMovesAtTheTop, boardWithWB.getMovesFromThis({2, 2}));
...
TEST(BoardTest, GetMovesFromThisWorksOnQueenMoves) {
    ...
    Moves expectedMovesAtTheBottom{{{5, 5}, {4, 4}}, {{5, 5}, {3, 3}}, {{5, 5}, {2, 2}}, {{5, 5}, {4, 6}},
                                   {{5, 5}, {3, 7}}, {{5, 5}, {6, 4}}, {{5, 5}, {6, 6}}, {{5, 5}, {7, 7}},
                                   {{5, 5}, {5, 4}}, {{5, 5}, {5, 6}}, {{5, 5}, {5, 7}}, {{5, 5}, {4, 5}},                                   {{5, 5}, {6, 5}}, {{5, 5}, {7, 5}}};
...
TEST(BoardTest, GetMovesFromThisWorksOnKingOneStepMoves) {
    ...
    EXPECT_EQ(expectedMovesAtTheBottom, boardWithBW.getMovesFromThis({6, 7}));    EXPECT_EQ(expectedMovesAtTheBottom, boardWithWB.getMovesFromThis({6, 7}));
...
TEST(BoardTest, GetMovesFromThisWorksOnKingMovesWithCastling) {
    ...
    Moves expectedMovesAtTheBottomOfWB{{{3, 7}, {2, 6}}, {{3, 7}, {2, 7}}, {{3, 7}, {3, 6}}, {{3, 7}, {4, 6}},                                       {{3, 7}, {4, 7}}, {{3, 7}, {1, 7}}, {{3, 7}, {5, 7}}};
...
TEST(BoardTest, GetMovesFromThisWorksOnKingMovesWithNoCastlingDueToBlocking) {
    ...
    Moves expectedMovesAtTheBottomOfWB{        {{3, 7}, {2, 6}}, {{3, 7}, {2, 7}}, {{3, 7}, {3, 6}}, {{3, 7}, {4, 6}}, {{3, 7}, {4, 7}}};
...
TEST(BoardTest, GetMovesToThisWorksOnOneAndTwoStepPawnNonCapture) {
    ...
    Moves expectedMovesAtTheTopOneStep{{{0, 1}, {0, 2}}};    Moves expectedMovesAtTheTopTwoStep{{{0, 1}, {0, 3}}};
...
TEST(BoardTest, GetMovesToThisWorksOnPawnCapture) {
    ...
    EXPECT_EQ(expectedMovesAtTheBottom, boardWithBW.getMovesToThis({5, 5}, PieceColor::White));    EXPECT_EQ(expectedMovesAtTheBottom, boardWithWB.getMovesToThis({5, 5}, PieceColor::Black));
...
TEST(BoardTest, GetMovesToThisWorksOnKnightMoves) {
    ...
    Moves expectedMovesAtTheTopWithEmptySpace{{{1, 1}, {3, 2}}};    Moves expectedMovesAtTheTopWithOpponentsPiece{{{1, 1}, {0, 3}}};
...
TEST(BoardTest, GetMovesToThisWorksOnBishopMoves) {
    ...
    Moves expectedMovesAtTheTopWithEmptySpace{{{2, 2}, {0, 0}}};    Moves expectedMovesAtTheTopWithOpponentsPiece{{{2, 2}, {4, 0}}};
...
TEST(BoardTest, GetMovesToThisWorksOnRookMoves) {
    ...
    Moves expectedMovesAtTheTopWithEmptySpace{{{2, 2}, {2, 0}}};    Moves expectedMovesAtTheTopWithOpponentsPiece{{{2, 2}, {0, 2}}};
...
TEST(BoardTest, GetMovesToThisWorksOnQueenMoves) {
    ...
    Moves expectedMovesAtTheTopWithEmptySpace{{{2, 2}, {0, 2}}};    Moves expectedMovesAtTheTopWithOpponentsPiece{{{2, 2}, {0, 0}}};
...
TEST(BoardTest, GetMovesToThisWorksOnKingMoves) {
    ...
    Moves expectedMovesAtTheTopWithEmptySpace{{{1, 0}, {2, 1}}};    Moves expectedMovesAtTheTopWithOpponentsPiece{{{1, 0}, {1, 1}}};
...
TEST(BoardTest, GetPieceAtWorks) {
    ...
    EXPECT_EQ(Piece(PieceColorAndType::WhiteRook), boardWithBW.getPieceAt({7, 7}));    EXPECT_EQ(Piece(PieceColorAndType::Empty), boardWithBW.getPieceAt({3, 3}));
    ...
    EXPECT_EQ(Piece(PieceColorAndType::BlackRook), boardWithWB.getPieceAt({7, 7}));    EXPECT_EQ(Piece(PieceColorAndType::Empty), boardWithWB.getPieceAt({3, 3}));
...
TEST(BoardTest, GetNotationPartOfFenStringWorks) {
    ...
    EXPECT_EQ("3kq3/rnb2bnr/P1P1P1P1/1P1P1P1P/pp2pp2/2pp2pp/RNB2BNR/3KQ3", board1.getNotationPartOfFenString());    EXPECT_EQ("r1bqkbnr/ppp1pppp/3p4/4n3/4P3/2N2N2/PPPP1PPP/R1BQKB1R", board2.getNotationPartOfFenString());
}
...
TEST(BoardTest, GetCastlingPartOfFenStringWorks) {
    ...
    EXPECT_EQ("Qk", board1.getCastlingPartOfFenString());    EXPECT_EQ("Kq", board2.getCastlingPartOfFenString());
}
...
TEST(BoardTest, IsACaptureMoveWorks) {
    ...
    EXPECT_FALSE(boardWithBW.isACaptureMove({{2, 2}, {0, 0}}));    EXPECT_FALSE(boardWithBW.isACaptureMove({{5, 5}, {7, 7}}));
}
...
TEST(BoardTest, IsACastlingMoveWorks) {
    ...
    EXPECT_TRUE(boardWithBW.isACastlingMove({{4, 7}, {2, 7}}));    EXPECT_FALSE(boardWithBW.isACastlingMove({{4, 7}, {6, 7}}));
}
...
TEST(BoardTest, IsAPossibleMoveWorksOnPawnCapture) {
    ...
    EXPECT_FALSE(boardWithBW.isAPossibleMove({{6, 6}, {7, 5}}));    EXPECT_FALSE(boardWithWB.isAPossibleMove({{6, 6}, {7, 5}}));
...
TEST(BoardTest, IsAPossibleMoveWorksOnKnightMoves) {
    ...
    EXPECT_TRUE(boardWithBW.isAPossibleMove({{6, 6}, {7, 4}}));    EXPECT_TRUE(boardWithWB.isAPossibleMove({{6, 6}, {7, 4}}));
...
TEST(BoardTest, IsAPossibleMoveWorksOnBishopMoves) {
    ...
    EXPECT_TRUE(boardWithBW.isAPossibleMove({{5, 5}, {3, 7}}));    EXPECT_TRUE(boardWithWB.isAPossibleMove({{5, 5}, {3, 7}}));
...
TEST(BoardTest, IsAPossibleMoveWorksOnRookMoves) {
    ...
    EXPECT_TRUE(boardWithBW.isAPossibleMove({{5, 5}, {7, 5}}));    EXPECT_TRUE(boardWithWB.isAPossibleMove({{5, 5}, {7, 5}}));
...
TEST(BoardTest, IsAPossibleMoveWorksOnQueenMoves) {
    ...
    EXPECT_TRUE(boardWithBW.isAPossibleMove({{5, 5}, {7, 7}}));    EXPECT_TRUE(boardWithWB.isAPossibleMove({{5, 5}, {7, 7}}));
...
TEST(BoardTest, IsAPossibleMoveWorksOnKingOneStepMoves) {
    ...
    EXPECT_TRUE(boardWithBW.isAPossibleMove({{7, 7}, {7, 6}}));    EXPECT_TRUE(boardWithWB.isAPossibleMove({{7, 7}, {7, 6}}));
...
TEST(BoardTest, IsAPossibleMoveWorksOnKingCastlingMoves) {
    ...
    EXPECT_TRUE(boardWithBW.isAPossibleMove({{4, 7}, {2, 7}}));    EXPECT_FALSE(boardWithBW.isAPossibleMove({{4, 7}, {6, 7}}));
...
TEST(BoardTest, IsAPossibleMoveWorksOnKingCastlingMovesWithKingOnCheck) {
    ...
    EXPECT_FALSE(boardWithBW.isAPossibleMove({{4, 7}, {2, 7}}));    EXPECT_FALSE(boardWithBW.isAPossibleMove({{4, 7}, {6, 7}}));
    EXPECT_TRUE(boardWithWB.isAPossibleMove({{3, 0}, {1, 0}}));
...
TEST(BoardTest, CanBeCapturedWorks) {
    ...
    EXPECT_FALSE(boardWithBW.canBeCaptured({4, 3}));    EXPECT_TRUE(boardWithBW.canBeCaptured({4, 4}));
...
TEST(BoardTest, AreThereAnyMovesToThisWorks) {
    ...
    EXPECT_FALSE(boardWithBW.areThereAnyMovesToThis({4, 3}, PieceColor::Black));    EXPECT_TRUE(boardWithBW.areThereAnyMovesToThis({4, 4}, PieceColor::Black));
...
TEST(BoardTest, HasOnlyOneMoveToThisWorks) {
    ...
    EXPECT_FALSE(boardWithBW.hasOnlyOneMoveToThis({4, 3}, PieceColor::Black));    EXPECT_FALSE(boardWithBW.hasOnlyOneMoveToThis({4, 4}, PieceColor::Black));
...
TEST(BoardTest, SetPieceAtWorks) {    Board boardWithBW;
...
TEST(BoardTest, MoveWorksForWhitePawnMovingTwoSpaces) {
    ...
    Board::PieceMatrix expectedMatrix(
        8U, 8U,
        {0xC, 0xA, 0xB, 0xD, 0xE, 0xB, 0xA, 0xC, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x9, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,         0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,

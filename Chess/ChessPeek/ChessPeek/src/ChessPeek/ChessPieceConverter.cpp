...
void ChessPieceConverter::initializeToChessDotCom()
{
    ...
    m_whitePiecesToBitValuesMap[PieceType::Pawn]   = 0B0000000000011000000110000001000000111100000100000011100001111110;
    m_whitePiecesToBitValuesMap[PieceType::Knight] = 0B0001000000111100001111000111111001101100000110000011101001111110;
    m_whitePiecesToBitValuesMap[PieceType::Bishop] = 0B0001100000010000001011000011110000111100001110000001100001111110;
    m_whitePiecesToBitValuesMap[PieceType::Rook]   = 0B0000000000111100001111000011010000111000001110000001100001111110;
    m_whitePiecesToBitValuesMap[PieceType::Queen]  = 0B0011100000011000100000100101111000111100001110000001100001111110;
    m_whitePiecesToBitValuesMap[PieceType::King]   = 0B0001100000000000011111100111111011011011011111000001100001111110;
    ...
    m_blackPiecesToBitValuesMap[PieceType::Knight] = 0B0001000000111100011111000111111001011110001111100000001001111110;
    m_blackPiecesToBitValuesMap[PieceType::Bishop] = 0B0001100000010000000111000011110000111100001111000100001001111110;
    m_blackPiecesToBitValuesMap[PieceType::Rook]   = 0B0000000000111100001111000011110000111100001111000100000001111110;
    m_blackPiecesToBitValuesMap[PieceType::Queen]  = 0B0011110000111100011111010111111001111110001111000100001001111110;
    m_blackPiecesToBitValuesMap[PieceType::King]   = 0B0001100000011000011111101101101111111011011111100000001001111110;
}

...
string const& ChessPeekConfiguration::getChessEnginePath() const
{
    return m_chessEnginePath;
}

string const& ChessPeekConfiguration::getScreenShotPath() const
{
...
{
    m_topLeftCorner = BitmapXY(2215, 151);    m_bottomRightCorner = BitmapXY(3022, 958);
    m_whiteColorLimit = 0.91;
    m_blackColorLimit = 0.40;
}

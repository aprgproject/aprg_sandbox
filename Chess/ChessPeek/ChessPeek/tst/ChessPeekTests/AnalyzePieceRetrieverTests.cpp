...
void writeBottomRightBorder(BitmapSnippet& outputSnippet, BitmapXY const& deltaChessBoard) {
...
void checkChessCellForWhiteAndBlackPoints(
    ...
    ChessPieceRetriever const& retriever, BitmapSnippet const& inputSnippet, PieceColorAndType const piece,
    unsigned int const xIndex, unsigned int const yIndex) {
...
void checkChessCellsForWhiteAndBlackPointsBlackUpWhiteDown(
    ...
    checkChessCellForWhiteAndBlackPoints(
        ...
        PieceColorAndType::BlackKnight, 1U, 0U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackBishop, 2U, 0U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackQueen, 3U, 0U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackKing, 4U, 0U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackBishop, 5U, 0U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackKnight, 6U, 0U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackRook, 7U, 0U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackPawn, 0U, 1U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackPawn, 1U, 1U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackPawn, 2U, 1U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackPawn, 3U, 1U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackPawn, 4U, 1U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackPawn, 5U, 1U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackPawn, 6U, 1U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackPawn, 7U, 1U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhiteRook, 7U, 7U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhitePawn, 0U, 6U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhitePawn, 1U, 6U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhitePawn, 2U, 6U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhitePawn, 3U, 6U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhitePawn, 4U, 6U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhitePawn, 5U, 6U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhitePawn, 6U, 6U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhitePawn, 7U, 6U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::BlackRook, 0U, 0U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhiteRook, 0U, 7U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhiteKnight, 1U, 7U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhiteBishop, 2U, 7U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhiteQueen, 3U, 7U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhiteKing, 4U, 7U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhiteBishop, 5U, 7U);
    checkChessCellForWhiteAndBlackPoints(
        whitePointsToUniquePiecesMap, blackPointsToUniquePiecesMap, retriever, inputSnippet,
        PieceColorAndType::WhiteKnight, 6U, 7U);
}

void printChessBitValuesWithBlackUpWhiteDown(ChessPieceRetriever const& retriever, BitmapSnippet const& inputSnippet) {
...
TEST(AnalyzePieceRetrieverTest, DISABLED_FindImportantPoints_ForChessDotComUserVsUser) {
    ...
    for (auto const& whitePointsAndUniquePiecesPair : whitePointsToUniquePiecesMap) {        outputSnippetForWhite.setPixelAt(
            whitePointsAndUniquePiecesPair.first, getLabelColor(whitePointsAndUniquePiecesPair.second));
    }
    for (auto const& blackPointsAndUniquePiecesPair : blackPointsToUniquePiecesMap) {
        outputSnippetForBlack.setPixelAt(
            blackPointsAndUniquePiecesPair.first, getLabelColor(blackPointsAndUniquePiecesPair.second));
    }
...
TEST(AnalyzePieceRetrieverTest, DISABLED_FindImportantPoints_ForChessDotComUserVsComputer) {
    ...
    AlbaLocalPathHandler outputFileForWhite(

...
TEST(ChessPieceConverterTest, ConvertBitValueToPieceWorksForChessDotComUserVsUserType)
{
    ...
    Piece actualPiece2(chessPeek.convertBitValueToPiece(PieceColor::Black, 0B0000000000010000000110000001100000111000000110000011110001111100));    Piece actualPiece3(chessPeek.convertBitValueToPiece(PieceColor::White, 0B0000000000000000000110000001000000111000000100000011110001111100));

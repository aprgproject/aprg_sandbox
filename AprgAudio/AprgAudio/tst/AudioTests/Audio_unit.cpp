...
TEST(AiffLoadingTests, Stereo_16bit_44100) {
    Audio<double> audioFile;    bool isLoadingSuccessful =
...
bool writeTest(int numChannels, int sampleRate, int bitDepth, AudioFormat format) {
    ...
    std::string bitDepthAsString = std::to_string(bitDepth);    std::string sampleRateAsString = std::to_string(sampleRate);

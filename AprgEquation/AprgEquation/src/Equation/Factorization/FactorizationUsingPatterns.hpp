...
Polynomials factorizeSumOfCubesIfPossible(Polynomial const& polynomial);void addFactorsOfDifferenceOfSquares(Polynomials & result, Polynomial const& polynomial);

...
TEST(TermsSimplificatorTest, ConstantRaiseToPowerVariablePatternCanBeSimplified)
{
    ...
    BaseTermSharedPointers const& baseTermPointersToVerify(termsToVerify.at(0).getExpressionConstReference().getWrappedTermsConstReference().getBaseTermPointersConstReference());
    ASSERT_EQ(3u, baseTermPointersToVerify.size());
    Term term1(*dynamic_cast<Term*>(baseTermPointersToVerify.at(0).get()));
    Term term2(*dynamic_cast<Term*>(baseTermPointersToVerify.at(1).get()));    Term term3(*dynamic_cast<Term*>(baseTermPointersToVerify.at(2).get()));
    ...
    ASSERT_EQ(TermType::Operator, term2.getTermType());    EXPECT_EQ("^", term2.getOperatorConstReference().getOperatorString());
...
TEST(TermsSimplificatorTest, MonomialRaiseToPowerVariablePatternWithSameMonomialVariableCanBeSimplified)
{
    ...
    EXPECT_DOUBLE_EQ(7, monomial.getConstantConstReference().getDouble());    Monomial::VariablesToExponentsMap const& variableMap(monomial.getVariablesToExponentsMapConstReference());
    ASSERT_EQ(1u, variableMap.size());
    EXPECT_DOUBLE_EQ(1, variableMap.at("x").getDouble());
...
TEST(TermsSimplificatorTest, MonomialRaiseToPowerMonomialPatternWithSameMonomialCanBeSimplified)
{
    ...
    EXPECT_DOUBLE_EQ(8, monomial1.getConstantConstReference().getDouble());    Monomial::VariablesToExponentsMap const& variableMap1(monomial1.getVariablesToExponentsMapConstReference());
    ASSERT_EQ(1u, variableMap1.size());

...
TEST(TermsSimplificatorTest, ConstantAddVariablePatternCanBeSimplified)
{
    ...
    Monomial::VariablesToExponentsMap const& variableMap2(monomials.at(1).getVariablesToExponentsMapConstReference());    ASSERT_EQ(1u, variableMap2.size());
...
TEST(TermsSimplificatorTest, VariableAddConstantPatternCanBeSimplified)
{
    ...
    EXPECT_DOUBLE_EQ(4, monomials.at(1).getConstantConstReference().getDouble());    Monomial::VariablesToExponentsMap const& variableMap2(monomials.at(1).getVariablesToExponentsMapConstReference());

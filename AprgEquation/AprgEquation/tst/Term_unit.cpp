...
TEST(TermTest, TermsAsExpressionsWorkAsExpected)
{
    ...
    WrappedTerms::BaseTermPointers const& baseTermPointersToVerify(expression2.getExpressionConstReference().getWrappedTermsConstReference().getBaseTermPointersConstReference());

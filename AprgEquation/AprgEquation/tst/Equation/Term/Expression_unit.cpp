...
TEST(ExpressionTest, PutTermWithAdditionUsingConstantWorks)
{
    ...
    Expression expressionToExpect3(createExpressionIfPossible({Term(695), Term("+"), Term("interest"), Term("+"), Term(42)}));
    Expression expressionToExpect4(createExpressionIfPossible({subExpression, Term("+"), Term(42)}));
    EXPECT_EQ(expressionToExpect1, expression1);
    EXPECT_EQ(expressionToExpect2, expression2);
    EXPECT_EQ(expressionToExpect3, expression3);
    EXPECT_EQ(expressionToExpect4, expression4);
...
TEST(ExpressionTest, PutTermWithAdditionUsingExpressionWithSameOperationLevelWorks)
{
    ...
    Expression expressionToExpect3(createExpressionIfPossible({Term(695), Term("+"), Term("interest"), Term("+"), Term("x"), Term("-"), Term("y")}));
    Expression expressionToExpect4(createExpressionIfPossible({subExpression, Term("+"), Term("x"), Term("-"), Term("y")}));
    EXPECT_EQ(expressionToExpect1, expression1);
    EXPECT_EQ(expressionToExpect2, expression2);
    EXPECT_EQ(expressionToExpect3, expression3);
    EXPECT_EQ(expressionToExpect4, expression4);
...
TEST(ExpressionTest, PutTermWithAdditionUsingExpressionWithDifferentOperationLevelWorks)
{
    ...
    Expression expressionToExpect1(createExpressionIfPossible({Term("x"), Term("/"), Term("y")}));
    Expression expressionToExpect2(createExpressionIfPossible({Term("x"), Term("/"), Term("y")}));
    Expression expressionToExpect3(createExpressionIfPossible({Term(695), Term("+"), Term("interest"), Term("+"), Term(subExpression1)}));
    Expression expressionToExpect4(createExpressionIfPossible({Term(subExpression2), Term("+"), Term(subExpression1)}));
    EXPECT_EQ(expressionToExpect1, expression1);
    EXPECT_EQ(expressionToExpect2, expression2);
    EXPECT_EQ(expressionToExpect3, expression3);
    EXPECT_EQ(expressionToExpect4, expression4);
...
TEST(ExpressionTest, PutTermWithSubtractionUsingExpressionWithDifferentOperationLevelWorks)
{
    ...
    Expression expressionToExpect2(expressionToExpect1);
    Expression expressionToExpect3(createExpressionIfPossible({Term(695), Term("+"), Term("interest"), Term("-"), Term(subExpression1)}));
    Expression expressionToExpect4(createExpressionIfPossible({subExpression2, Term("-"), Term(subExpression1)}));
    EXPECT_EQ(expressionToExpect1, expression1);
    EXPECT_EQ(expressionToExpect2, expression2);
    EXPECT_EQ(expressionToExpect3, expression3);
    EXPECT_EQ(expressionToExpect4, expression4);
...
{
    Expression expression1;
    Expression expression2(createOrCopyExpressionFromATerm(Term(Constant(1))));
    Expression expression3(createExpressionIfPossible({Term(695), Term("*"), Term("interest")}));
    Expression expression4(createExpressionIfPossible({Term(695), Term("+"), Term("interest")}));
    ...
    Expression expressionToExpect1;
    Expression expressionToExpect2(createOrCopyExpressionFromATerm(Term(Constant(1))));
    Expression expressionToExpect3(createExpressionIfPossible({Term(695), Term("*"), Term("interest")}));
    Expression expressionToExpect4(createExpressionIfPossible({Term(695), Term("+"), Term("interest")}));
    EXPECT_EQ(expressionToExpect1, expression1);
    EXPECT_EQ(expressionToExpect2, expression2);
...
TEST(ExpressionTest, PutTermWithRaiseToPowerWorks)
{
    ...
    Expression expressionToExpect3(createExpressionIfPossible({Term(695), Term("^"), Term("interest"), Term("^"), Term(42)}));
    Expression expressionToExpect4(createExpressionIfPossible({expressionInExponent, Term("^"), Term(42)}));
    EXPECT_EQ(expressionToExpect1, expression1);
    EXPECT_EQ(expressionToExpect2, expression2);
    EXPECT_EQ(expressionToExpect3, expression3);
    EXPECT_EQ(expressionToExpect4, expression4);
...
TEST(ExpressionTest, PutTermWithRaiseToPowerUsingExpressionWithSameOperationLevelWorks)
{
    ...
    Expression expressionToExpect1(createExpressionIfPossible({Term("x"), Term("^"), Term("y")}));
    Expression expressionToExpect2(createExpressionIfPossible({Term(1), Term("^"), Term("x"), Term("^"), Term("y")}));
    Expression expressionToExpect3(createExpressionIfPossible({Term(695), Term("^"), Term("interest"), Term("^"), Term("x"), Term("^"), Term("y")}));

...
TEST(FactorizationUtilitiesTest, ReturnPolynomialsOrSinglePolynomialIfEmptyWorksWhenPolynomialsIsEmpty)
{
    ...
    ASSERT_EQ(1u, polynomialsToVerify.size());    Polynomial polynomialToExpect1(singlePolynomial);
    EXPECT_EQ(polynomialToExpect1, polynomialsToVerify.at(0));
}
...
TEST(FactorizationUtilitiesTest, FactorizeCommonMonomialWorksWhenItCanBeFactored)
{
    ...
    ASSERT_EQ(2u, polynomialsToVerify.size());    Polynomial polynomialToExpect1{Monomial(3, {{"x", 1}})};
...
TEST(FactorizationUtilitiesTest, IsPerfectSquareWorks)
{
    ...
    EXPECT_TRUE(isPerfectSquare(monomial1));    EXPECT_TRUE(isPerfectSquare(monomial2));
...
TEST(FactorizationUtilitiesTest, IsPerfectCubeWorks)
{
    ...
    EXPECT_TRUE(isPerfectCube(monomial1));    EXPECT_TRUE(isPerfectCube(monomial2));
...
TEST(FactorizationUtilitiesTest, IsPerfectNthPowerWorks)
{
    ...
    EXPECT_TRUE(isPerfectNthPower(monomial1, 4));    EXPECT_TRUE(isPerfectNthPower(monomial2, 4));
...
TEST(FactorizationUtilitiesTest, AreExponentsDivisibleWorks)
{
    ...
    EXPECT_TRUE(areExponentsDivisible(monomial1, 4));    EXPECT_TRUE(areExponentsDivisible(monomial2, 4));

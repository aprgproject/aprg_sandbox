...
TEST(UtilitiesTest, DISABLED_SearchForBestSampleIndexesWorksWithReplacingSamples)
{
    ...
    AlbaLocalPathHandler audioToSearchFilePathHandler(audioDirectoryPathHandler.getDirectory()+"AChannel_AOpeningSong_001.wav"); //AChannel_AOpeningSong_001
...
TEST(UtilitiesTest, DISABLED_SearchAndTryToReplicateSamplesWorks)
{
    AlbaLocalPathHandler audioDirectoryPathHandler(SAMPLE_AUDIO_FILES_DIRECTORY);
    AlbaLocalPathHandler audioToReplicateFilePathHandler(audioDirectoryPathHandler.getDirectory()+"John Mayer-Neon.wav");
    AlbaLocalPathHandler audioToSearchFilePathHandler(audioDirectoryPathHandler.getDirectory()+"AChannel_AOpeningSong_001.wav");
...
TEST(UtilitiesTest, DISABLED_SearchAndTryToReplicateWorks)
{
    ...
    searchAndTryToReplicate(
                ...
                audioToSearchFilePathHandler.getFullPath(),
                true);
}

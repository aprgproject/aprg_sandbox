...
if(WIN32)
    ...
    set(APRG_COMMON_INCLUDE_DIRECTORIES ${APRG_COMMON_INCLUDE_DIRECTORIES} ${APRG_COMMON_WINDOWS_SOURCE_DIRECTORY} )
    set(APRG_COMMON_TEST_INCLUDE_DIRECTORIES ${APRG_COMMON_TEST_INCLUDE_DIRECTORIES} ${APRG_COMMON_WINDOWS_TEST_DIRECTORY} )
elseif(UNIX)
    PRINT_STATUS("Looking for Linux SRC directories in: [${APRG_COMMON_LINUX_SOURCE_DIRECTORY}]")
    GET_SUB_DIRECTORY_LIST(APRG_COMMON_LINUX_SOURCE_DIRECTORY_LIST ${APRG_COMMON_LINUX_SOURCE_DIRECTORY})
    GET_SOURCE_FILES_FROM_DIRECTORIES(APRG_COMMON_LINUX_SOURCES APRG_COMMON_LINUX_SOURCE_DIRECTORY_LIST)

    PRINT_STATUS("Looking for Linux TST directories in: [${APRG_COMMON_LINUX_TEST_DIRECTORY}]")
    GET_SUB_DIRECTORY_LIST(APRG_COMMON_LINUX_TEST_DIRECTORY_LIST ${APRG_COMMON_LINUX_TEST_DIRECTORY})
    GET_SOURCE_FILES_FROM_DIRECTORIES(APRG_COMMON_LINUX_TESTS APRG_COMMON_LINUX_TEST_DIRECTORY_LIST)
    ...
    set(APRG_COMMON_INCLUDE_DIRECTORIES ${APRG_COMMON_INCLUDE_DIRECTORIES}  ${APRG_COMMON_LINUX_SOURCE_DIRECTORY} )
    set(APRG_COMMON_TEST_INCLUDE_DIRECTORIES ${APRG_COMMON_TEST_INCLUDE_DIRECTORIES} ${APRG_COMMON_LINUX_TEST_DIRECTORY} )
endif(
    )

...
TEST(AlbaNumberIntervalEndpointTest, ConstructionForEndpointWorksAsExpected)
{
...
TEST(AlbaNumberIntervalEndpointTest, EqualityForEndpointsWorksAsExpected)
{
    AlbaNumberIntervalEndpoint endpoint1(AlbaNumberIntervalEndpoint::Type::Open, 645);
...
TEST(AlbaNumberIntervalEndpointTest, IsOpenForEndpointWorksAsExpected)
{
    AlbaNumberIntervalEndpoint endpoint1(AlbaNumberIntervalEndpoint::Type::Open, 645);
    AlbaNumberIntervalEndpoint endpoint2(AlbaNumberIntervalEndpoint::Type::Close, 784);
...
TEST(AlbaNumberIntervalEndpointTest, IsCloseForEndpointWorksAsExpected)
{
    AlbaNumberIntervalEndpoint endpoint1(AlbaNumberIntervalEndpoint::Type::Open, 645);
    AlbaNumberIntervalEndpoint endpoint2(AlbaNumberIntervalEndpoint::Type::Close, 784);
...
TEST(AlbaNumberIntervalEndpointTest, GetTypeForEndpointWorksAsExpected)
{
    AlbaNumberIntervalEndpoint endpoint1(AlbaNumberIntervalEndpoint::Type::Open, 645);
    AlbaNumberIntervalEndpoint endpoint2(AlbaNumberIntervalEndpoint::Type::Close, 784);
...
TEST(AlbaNumberIntervalEndpointTest, GetValueForEndpointWorksAsExpected)
{
    AlbaNumberIntervalEndpoint endpoint1(AlbaNumberIntervalEndpoint::Type::Open, 645);
    AlbaNumberIntervalEndpoint endpoint2(AlbaNumberIntervalEndpoint::Type::Close, 784);
...
TEST(AlbaNumberIntervalEndpointTest, GetTypeStringForEndpointWorksAsExpected)
{
    AlbaNumberIntervalEndpoint endpoint1(AlbaNumberIntervalEndpoint::Type::Open, 645);
    AlbaNumberIntervalEndpoint endpoint2(AlbaNumberIntervalEndpoint::Type::Close, 784);
...
TEST(AlbaNumberIntervalEndpointTest, GetDisplayableStringForEndpointWorksAsExpected)
{
    AlbaNumberIntervalEndpoint endpoint1(AlbaNumberIntervalEndpoint::Type::Open, 645);
    AlbaNumberIntervalEndpoint endpoint2(AlbaNumberIntervalEndpoint::Type::Close, 784);
...
TEST(AlbaNumberIntervalEndpointTest, SetTypeForEndpointWorksAsExpected)
{
...
TEST(AlbaNumberTest, ConstructionForIntervalWorksAsExpected)
{
    ...
    EXPECT_EQ(createCloseEndpoint(784), interval1.getHigherEndpoint());    EXPECT_EQ(createOpenEndpoint(645), interval2.getLowerEndpoint());
    EXPECT_EQ(createCloseEndpoint(784), interval2.getHigherEndpoint());
}

TEST(AlbaNumberIntervalEndpointTest, EqualityForIntervalsWorksAsExpected)
{
...
TEST(AlbaNumberIntervalTest, GetLowerEndpointWorksAsExpected)
{
...
TEST(AlbaNumberIntervalTest, GetHigherEndpointWorksAsExpected)
{
    AlbaNumberInterval interval(createOpenEndpoint(645), createCloseEndpoint(784));
...
TEST(AlbaNumberIntervalTest, GetDisplayableStringForIntervalWorksAsExpected)
{
    AlbaNumberInterval interval(createOpenEndpoint(645), createCloseEndpoint(784));
...
TEST(AlbaNumberIntervalTest, SetNewEndpointWorksAsExpected)
{
...
TEST(AlbaNumberIntervalEndpointTest, CreateOpenEndpointWorksAsExpected)
{
...
TEST(AlbaNumberIntervalEndpointTest, CreateCloseEndpointWorksAsExpected)
{
...
TEST(AlbaNumberIntervalEndpointTest, CreateEndpointWorksAsExpected)
{
...
TEST(AlbaNumberIntervalTest, CreateAllRealValuesIntervalWorksAsExpected)
{

...
TEST(PathTest, FullPathWithDirectoryAndFileGiven)
{
    ...
    EXPECT_EQ(pathHandler.getFilenameOnly(), "76543");    EXPECT_EQ(pathHandler.getExtension(), "txt");
...
TEST(PathTest, FileOnly)
{
    ...
    EXPECT_EQ(pathHandler.getFilenameOnly(), "src");    EXPECT_TRUE(pathHandler.getExtension().empty());
    EXPECT_EQ(pathHandler.getPathType(), PathType::File);
...
TEST(WebPathTest, DirectoryWithColonAndFileGivenAndNoProtocol)
{
    ...
    EXPECT_EQ(pathHandler.getDirectory(), R"(\\::://directory!@#$%12345/)");    EXPECT_EQ(pathHandler.getFile(), "file.txt");
...
TEST(WebPathTest, FullPathWithOnlyDirectoryGiven_HttpStyleInput)
{
    ...
    EXPECT_EQ(pathHandler.getDirectory(), "hTTp://www.google.com/!@#$%12345/");    EXPECT_TRUE(pathHandler.getFile().empty());
...
TEST(WebPathTest, FullPathWithQuestionMark)
{
    ...
    EXPECT_TRUE(pathHandler.hasProtocol());
    EXPECT_EQ(pathHandler.getProtocol(), "http");
    EXPECT_EQ(pathHandler.getDirectory(), "http://a.mhcdn.net/store/manga/12114/001.0/compressed/");    EXPECT_EQ(pathHandler.getFile(), "r049.jpg");
...
TEST(WebPathTest, GotoLinkWhenNoProtocolIsGiven)
{
    ...
    EXPECT_TRUE(pathHandler.hasProtocol());    EXPECT_EQ(pathHandler.getProtocol(), "http");
...
TEST(WebPathTest, GotoLinkWhenWithProtocolIsGiven)
{
    ...
    EXPECT_TRUE(pathHandler.hasProtocol());    EXPECT_EQ(pathHandler.getProtocol(), "ftp");
...
TEST(WindowsPathTest, FullPathWithDirectoryAndFileGiven_WithNumbersAndSpecialCharacters)
{
    ...
    EXPECT_EQ(pathHandler.getDrive(), "C");
    EXPECT_EQ(pathHandler.getDirectory(), R"(C:\APRG12345\Aprg!@#$%Common\AprgCommon\tst\)");
    EXPECT_EQ(pathHandler.getFile(), "zxcvbnm12345.txt");    EXPECT_EQ(pathHandler.getFilenameOnly(), "zxcvbnm12345");
    EXPECT_EQ(pathHandler.getExtension(), "txt");
    EXPECT_EQ(pathHandler.getPathType(), PathType::File);
}
...
TEST(WindowsPathTest, FullPathWithDirectoryAndFileNoFileExtensionGiven_WithNumbersAndSpecialCharacters)
{
    ...
    EXPECT_EQ(pathHandler.getDrive(), "C");
    EXPECT_EQ(pathHandler.getDirectory(), R"(C:\APRG12345\Aprg!@#$%Common\AprgCommon\tst\)");
    EXPECT_EQ(pathHandler.getFile(), "zxcvbnm12345.");    EXPECT_EQ(pathHandler.getFilenameOnly(), "zxcvbnm12345");
    EXPECT_TRUE(pathHandler.getExtension().empty());
    EXPECT_EQ(pathHandler.getPathType(), PathType::File);
}
...
TEST(WindowsPathTest, FullPathWithDirectoryAndFileExtensionOnlyGiven_WithNumbersAndSpecialCharacters)
{
    ...
    EXPECT_EQ(pathHandler.getDrive(), "C");
    EXPECT_EQ(pathHandler.getDirectory(), R"(C:\APRG12345\Aprg!@#$%Common\AprgCommon\tst\)");
    EXPECT_EQ(pathHandler.getFile(), ".zxcvbnm12345");    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
...
TEST(WindowsPathTest, FullPathWithDirectoryAndFileNoFileExtensionGiven_WithNumbersAndSpecialCharactersTwoTimes)
{
    ...
    EXPECT_EQ(pathHandler.getDrive(), "C");
    EXPECT_EQ(pathHandler.getDirectory(), R"(C:\APRG12345\Aprg!@#$%Common\Aprg1111Common\tst\)");
    EXPECT_EQ(pathHandler.getFile(), "76543.txt");    EXPECT_EQ(pathHandler.getFilenameOnly(), "76543");
    EXPECT_EQ(pathHandler.getExtension(), "txt");
    EXPECT_EQ(pathHandler.getPathType(), PathType::File);
    ...
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_EQ(pathHandler.getExtension(), "zxcvbnm12345");    EXPECT_EQ(pathHandler.getPathType(), PathType::File);
}
...
TEST(WindowsPathTest, FullPathWithDirectoryAndFile_DoublePeriodInPath)
{
    ...
    EXPECT_EQ(pathHandler.getFile(), "file.txt");    EXPECT_EQ(pathHandler.getFilenameOnly(), "file");
    EXPECT_EQ(pathHandler.getExtension(), "txt");
    EXPECT_EQ(pathHandler.getPathType(), PathType::File);
...
TEST(WindowsPathTest, FullPathWithDirectoryAndFile_ActualLocalDirectory)
{
    ...
    EXPECT_EQ(pathHandler.getFile(), "File1.log");    EXPECT_EQ(pathHandler.getFilenameOnly(), "File1");
    ...
    EXPECT_EQ(pathHandler.getDrive(), "C");
    EXPECT_EQ(pathHandler.getDirectory(), R"(C:\APRG\AprgCommon\AprgCommon\tst\FilesForTests\)");
    EXPECT_EQ(pathHandler.getFile(), "thisFileDoesNotExist.txt");    EXPECT_EQ(pathHandler.getFilenameOnly(), "thisFileDoesNotExist");
    EXPECT_EQ(pathHandler.getExtension(), "txt");
    EXPECT_EQ(pathHandler.getPathType(), PathType::File);
...
TEST(WindowsPathTest, FileSizeTest)
{
    ...
    ASSERT_EQ(pathHandler.isFoundInLocalSystem(), true);    EXPECT_DOUBLE_EQ(pathHandler.getFileSizeEstimate(), 5000);
}

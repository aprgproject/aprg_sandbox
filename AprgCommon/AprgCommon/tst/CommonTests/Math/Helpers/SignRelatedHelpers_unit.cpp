...
TEST(SignRelatedHelpersTest, GetAbsoluteValueWorksForPrimitiveTypes)
{
    ...
    EXPECT_EQ(1, getAbsoluteValue(-1));    EXPECT_EQ(0, getAbsoluteValue(0));
...
TEST(SignRelatedHelpersTest, GetSignWorksForPrimitiveTypes)
{
    ...
    EXPECT_EQ(1, getSign(0));    EXPECT_EQ(1, getSign(10));
}
...
TEST(SignRelatedHelpersTest, ConvertToIntegerThenSubtractWorks)
{
    EXPECT_EQ(0, convertToIntegerThenSubtract(0U, 0U));
    EXPECT_EQ(0, convertToIntegerThenSubtract(5U, 5U));    EXPECT_EQ(4, convertToIntegerThenSubtract(5U, 1U));

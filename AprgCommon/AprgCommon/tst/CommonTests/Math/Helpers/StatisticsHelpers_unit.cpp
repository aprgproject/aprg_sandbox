...
TEST(StatisticsHelpersTest, GetCumulativeStandardDistributionApproximationWorks)
{
    ...
    EXPECT_DOUBLE_EQ(0.5, getCumulativeStandardDistributionApproximation(0));    EXPECT_DOUBLE_EQ(0.86433393905361732834, getCumulativeStandardDistributionApproximation(1.1));
...
TEST(StatisticsHelpersTest, GetInverseCumulativeStandardDistributionApproximationWorks)
{
    ...
    EXPECT_DOUBLE_EQ(1.0999774932861328125, getInverseCumulativeStandardDistributionApproximation(0.86433, 20));    EXPECT_DOUBLE_EQ(-2.4003314971923828125, getInverseCumulativeStandardDistributionApproximation(0.00819, 20));

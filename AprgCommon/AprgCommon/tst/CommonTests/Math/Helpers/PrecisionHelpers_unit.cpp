...
TEST(PrecisionHelpersTest, DoubleTypesCanBeConsideredEqual)
{
    ...
    EXPECT_FALSE(isAlmostEqual(static_cast<double>(1)/3, static_cast<double>(1)/3+0.1));    EXPECT_TRUE(isAlmostEqual(static_cast<double>(1)/3, static_cast<double>(1)/3+1E-13));
    EXPECT_TRUE(isAlmostEqual(1E-12, 1E-12));
    EXPECT_FALSE(isAlmostEqual(static_cast<double>(0), 1E-11));
    EXPECT_FALSE(isAlmostEqual(static_cast<double>(0), 1E-12));    EXPECT_TRUE(isAlmostEqual(static_cast<double>(0), 1E-13));
...
TEST(PrecisionHelpersTest, IsAlmostEqualWorksWithDifferenceTolerance)
{
    ...
    EXPECT_TRUE(isAlmostEqual(2.54, 2.55, 1E-2));    EXPECT_FALSE(isAlmostEqual(2.54, 2.55, 1E-3));
...
TEST(PrecisionHelpersTest, IsAlmostAnIntegerWorks)
{
    ...
    EXPECT_TRUE((isAlmostAnInteger<float, int>(1)));    EXPECT_TRUE((isAlmostAnInteger<float, int>(2)));
    EXPECT_FALSE((isAlmostAnInteger<float, int>(3.00001)));
    EXPECT_TRUE((isAlmostAnInteger<float, int>(3.0000000000001)));
    EXPECT_TRUE((isAlmostAnInteger<double, int>(0)));    EXPECT_TRUE((isAlmostAnInteger<double, int>(1)));
...
TEST(PrecisionHelpersTest, IsAlmostAnIntegerWithDifferenceToleranceWorks)
{
    ...
    EXPECT_TRUE(isAlmostAnInteger(3.01, 1E-2));    EXPECT_FALSE(isAlmostAnInteger(3.01, 1E-3));
...
TEST(PrecisionHelpersTest, IsValueBeyondLimitsWorksForInteger)
{
    ...
    EXPECT_FALSE(isValueBeyondLimits<int>(INT_MIN));    EXPECT_FALSE(isValueBeyondLimits<int>(1000));
...
TEST(PrecisionHelpersTest, IsValueBeyondUnsignedIntegerLimitsWorks)
{
    ...
    EXPECT_FALSE(isValueBeyondLimits<unsigned int>(0));    EXPECT_FALSE(isValueBeyondLimits<unsigned int>(1000));
...
TEST(PrecisionHelpersTest, IsValueBeyondShortIntegerLimitsWorks)
{
    ...
    EXPECT_FALSE(isValueBeyondLimits<short int>(SHRT_MIN));    EXPECT_FALSE(isValueBeyondLimits<short int>(1000));
...
TEST(PrecisionHelpersTest, IsValueBeyondLongIntegerLimitsWorks)
{
    ...
    EXPECT_FALSE(isValueBeyondLimits<long int>(LONG_MIN));    EXPECT_FALSE(isValueBeyondLimits<long int>(1000));
...
TEST(PrecisionHelpersTest, IsValueBeyondUnsignedLongIntegerLimitsWorks)
{
    ...
    EXPECT_FALSE(isValueBeyondLimits<unsigned long int>(0));    EXPECT_FALSE(isValueBeyondLimits<unsigned long int>(1000));
...
TEST(PrecisionHelpersTest, IsValueBeyondLongLongIntegerLimitsWorks)
{
    ...
    EXPECT_FALSE(isValueBeyondLimits<long long int>(LLONG_MIN));    EXPECT_FALSE(isValueBeyondLimits<long long int>(1000));
...
TEST(PrecisionHelpersTest, IsValueBeyondUnsignedLongLongIntegerLimitsWorks)
{
    ...
    EXPECT_FALSE(isValueBeyondLimits<unsigned long long int>(0));    EXPECT_FALSE(isValueBeyondLimits<unsigned long long int>(1000));
...
TEST(PrecisionHelpersTest, GetIntegerAfterRoundingADoubleValueWorks)
{
    ...
    EXPECT_EQ(1, getIntegerAfterRoundingADoubleValue<int>(1));    EXPECT_EQ(2, getIntegerAfterRoundingADoubleValue<int>(1.5));
    EXPECT_EQ(-2, getIntegerAfterRoundingADoubleValue<int>(-1.5));
    EXPECT_EQ(652, getIntegerAfterRoundingADoubleValue<int>(652.426542));
    EXPECT_EQ(-348, getIntegerAfterRoundingADoubleValue<int>(-347.51514));    EXPECT_EQ(0U, getIntegerAfterRoundingADoubleValue<unsigned int>(0));
...
TEST(PrecisionHelpersTest, GetIntegerAfterFloorOfDoubleValueWorks)
{
    ...
    EXPECT_EQ(1, getIntegerAfterFloorOfDoubleValue<int>(1));    EXPECT_EQ(1, getIntegerAfterFloorOfDoubleValue<int>(1.5));
    EXPECT_EQ(-2, getIntegerAfterFloorOfDoubleValue<int>(-1.5));
    EXPECT_EQ(652, getIntegerAfterFloorOfDoubleValue<int>(652.426542));
    EXPECT_EQ(-348, getIntegerAfterFloorOfDoubleValue<int>(-347.51514));    EXPECT_EQ(0U, getIntegerAfterFloorOfDoubleValue<unsigned int>(0));
...
TEST(PrecisionHelpersTest, GetIntegerAfterCeilingOfDoubleValueWorks)
{
    ...
    EXPECT_EQ(1, getIntegerAfterCeilingOfDoubleValue<int>(1));    EXPECT_EQ(2, getIntegerAfterCeilingOfDoubleValue<int>(1.5));
    EXPECT_EQ(-1, getIntegerAfterCeilingOfDoubleValue<int>(-1.5));
    EXPECT_EQ(653, getIntegerAfterCeilingOfDoubleValue<int>(652.426542));
    EXPECT_EQ(-347, getIntegerAfterCeilingOfDoubleValue<int>(-347.51514));    EXPECT_EQ(0U, getIntegerAfterCeilingOfDoubleValue<unsigned int>(0));
...
TEST(PrecisionHelpersTest, IntegerPartInDoubleWorks)
{
    EXPECT_EQ(0, getIntegerPartInDouble(0));
    EXPECT_EQ(1, getIntegerPartInDouble(1));    EXPECT_EQ(1, getIntegerPartInDouble(1.5));
...
TEST(PrecisionHelpersTest, FractionalPartInDoubleWorks)
{
    ...
    EXPECT_DOUBLE_EQ(0, getFractionalPartInDouble(1));    EXPECT_DOUBLE_EQ(0.5, getFractionalPartInDouble(1.5));
...
TEST(PrecisionHelpersTest, ConvertIfInfinityToNearestFiniteValueWorks)
{
    ...
    EXPECT_DOUBLE_EQ(1.7976931348623157e+308, convertIfInfinityToNearestFiniteValue(AlbaNumber(AlbaNumber::Value::PositiveInfinity)).getDouble());    EXPECT_DOUBLE_EQ(-1.7976931348623157e+308, convertIfInfinityToNearestFiniteValue(AlbaNumber(AlbaNumber::Value::NegativeInfinity)).getDouble());
}

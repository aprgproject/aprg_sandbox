...
{
    AlbaWindowsPathHandler pathHandler(pathOfAprgDirectory + R"(////AprgCommon\\\\/AprgCommon/tst\FilesForTests\)");
    EXPECT_EQ(getDriveOfAprgDir(), pathHandler.getDriveOrRoot());
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\)"), pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
...
{
    AlbaWindowsPathHandler pathHandler(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\File1.log)");
    EXPECT_EQ(getDriveOfAprgDir(), pathHandler.getDriveOrRoot());
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\)"), pathHandler.getDirectory());
    ...
    pathHandler.input(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\thisFileDoesNotExist.txt)");
    EXPECT_EQ(getDriveOfAprgDir(), pathHandler.getDriveOrRoot());
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\)"), pathHandler.getDirectory());
    ...
    pathHandler.input(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests)");
    EXPECT_EQ(getDriveOfAprgDir(), pathHandler.getDriveOrRoot());
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\)"), pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
...
{
    string const pathOfFileToBeDeleted(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\FileToBeDeleted.log)");
...
{
    string const pathOfFileToBeRenamed(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\FileToBeRenamed.log)");
...
{
    string const pathOfFileToBeCopied(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\FileToBeCopied.log)");
    ...
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\)"), pathHandlerOfCopiedFile.getDirectory());
...
{
    string const pathOfDirectoryToBeRenamed(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR1)");

    AlbaWindowsPathHandler pathHandler(pathOfDirectoryToBeRenamed);
    EXPECT_EQ(getDriveOfAprgDir(), pathHandler.getDriveOrRoot());
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR1\)"),  pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_TRUE(pathHandler.getExtension().empty());    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
    EXPECT_TRUE(pathHandler.isFoundInLocalSystem());
    ...
    EXPECT_EQ(getDriveOfAprgDir(), pathHandler.getDriveOrRoot());
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\RenamedDirectory\)"), pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_TRUE(pathHandler.getExtension().empty());    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
    EXPECT_TRUE(pathHandler.isFoundInLocalSystem());
...
{
    AlbaWindowsPathHandler pathHandler(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\)");
    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
    ...
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR3\)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR4\)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR5\)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR6\)"), *(itDirectories++));
}
...
TEST_F(AlbaWindowsPathHandlerTest, FullPathWithDirectory_FindFileAndDirectoryMultipleDepthTwo)
{
    ...
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR3\File3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR4\File4.mp3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR5\File5.avi)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\File1.log)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\File2.txt)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\File3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\File4.mp3)"), *(itFiles++));
    ...
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR5\)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR6\)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR6\SUBDIR1\)"), *(itDirectories++));
}
...
TEST_F(AlbaWindowsPathHandlerTest, FullPathWithDirectory_FindFileAndDirectoryUnlimitedDepth)
{
    ...
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR4\File4.mp3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR5\File5.avi)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\DIR6\SUBDIR1\File6.jpg)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\File1.log)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\File2.txt)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\File3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(pathOfAprgDirectory + R"(AprgCommon\AprgCommon\tst\FilesForTests\DirectoryTest\File4.mp3)"), *(itFiles++));

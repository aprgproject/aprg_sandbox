...
public:
    ...
    static inline constexpr bool isEvenParity(DataType const value)
    {
        return BitUtilitiesBuiltIn::isEvenParity(value);
    }
    ...
    static constexpr inline DataType getOnesComplement(DataType const value)
    {
        return ~value;
    }

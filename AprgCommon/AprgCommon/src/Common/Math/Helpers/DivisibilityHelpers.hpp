...
// and found that in each case, the output for and.c and modulo.c were identical (they both used the andl $1, %eax instruction).
// I doubt this is a "new" feature, and I suspect it dates back to ancient versions.
// I also doubt any modern (made in the past 20 years) non-arcane compiler, commercial or open source, lacks such optimization.
// I would test on other compilers, but I don't have any available at the moment.

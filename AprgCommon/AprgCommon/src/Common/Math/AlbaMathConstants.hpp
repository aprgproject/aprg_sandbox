...
constexpr double DOUBLE_EPSILON = std::numeric_limits<double>::epsilon(); // The difference between 1.0 and the next value representable by the floating-point type T.

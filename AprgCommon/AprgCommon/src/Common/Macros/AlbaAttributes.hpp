...
// ---> class/struct/union: struct [[maybe_unused]] S;,// ---> typedef, including those declared by alias declaration: [[maybe_unused]] typedef S* PS;, using PS [[maybe_unused]] = S*;,
...
// -> string-literal 	- 	text that could be used to explain the rationale for why the result should not be discarded// Explanation
...
// -> [[likely]] 	(1)
// -> [[unlikely]] 	(2)
// -> Explanation// -> These attributes may be applied to labels and statements (other than declaration-statements).

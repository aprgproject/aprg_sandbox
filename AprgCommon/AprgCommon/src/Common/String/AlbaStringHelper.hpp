...
bool isPrefix(std::string const& mainString, std::string const& prefix);bool isSuffix(std::string const& mainString, std::string const& suffix);
...
bool isBorder(std::string const& mainString, std::string const& border);bool isEqualNotCaseSensitive(std::string const& mainString, std::string const& string2);

...
#define Z_ALBA_PRIVATE_DEBUG_GET_STRING_LITERALS4(parameter, ...)                  Z_ALBA_PRIVATE_DEBUG_GET_STRING_LITERALS_EXPANSION(parameter, Z_ALBA_PRIVATE_DEBUG_GET_STRING_LITERALS3(__VA_ARGS__))

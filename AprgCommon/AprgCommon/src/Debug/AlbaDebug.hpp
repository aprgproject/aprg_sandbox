...
#define Z_ALBA_PRIVATE_GET_STRING_PRINT1(parameter1)                      ALBA_MACROS_GET_STRING_LITERAL(parameter1) << ":[" << parameter1 << "] "#define Z_ALBA_PRIVATE_GET_STRING_PRINT2(parameter1, parameter2)          ALBA_MACROS_GET_STRING_LITERAL(parameter1) << ":[" << parameter1 << "] " << ALBA_MACROS_GET_STRING_LITERAL(parameter2) << ":[" << parameter2 << "] "
...
#define ALBA_EXIT exit(0)#define ALBA_PRINT0(parameter) cout << "ALBA_PRINT0:" << parameter << endl

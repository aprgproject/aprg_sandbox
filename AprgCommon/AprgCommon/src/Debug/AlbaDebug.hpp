...
#define ALBA_PRINT3(...) cout << "ALBA_PRINT3 in " << __FUNCTION__ << "(...): " << Z_ALBA_PRIVATE_GET_STRING_PRINT3(__VA_ARGS__) << endl#define ALBA_PRINT4(...) cout << "ALBA_PRINT4 in " << __FUNCTION__ << "(...): " << Z_ALBA_PRIVATE_GET_STRING_PRINT4(__VA_ARGS__) << endl

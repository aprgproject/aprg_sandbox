...
#define ALBA_PRECISION(parameter) ALBA_PRINT_OUTPUT_STREAM.precision(parameter)
#define ALBA_EXIT exit(0)
#define ALBA_PRINT0(parameter) ALBA_PRINT_OUTPUT_STREAM << "ALBA_PRINT0 in " << __FUNCTION__ << "(...): " << parameter << endl
#define ALBA_PRINT1(...) ALBA_PRINT_OUTPUT_STREAM << "ALBA_PRINT1 in " << __FUNCTION__ << "(...): " << Z_ALBA_PRIVATE_GET_STRING_PRINT1(__VA_ARGS__) << endl
#define ALBA_PRINT2(...) ALBA_PRINT_OUTPUT_STREAM << "ALBA_PRINT2 in " << __FUNCTION__ << "(...): " << Z_ALBA_PRIVATE_GET_STRING_PRINT2(__VA_ARGS__) << endl

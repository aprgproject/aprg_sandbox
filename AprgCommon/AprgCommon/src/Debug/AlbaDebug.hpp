...
#define ALBA_PRINT0(parameter) ALBA_PRINT_OUTPUT_STREAM << "ALBA_PRINT0 in " << __FUNCTION__ << "(...): " << parameter << endl
#define ALBA_PRINT1(...) ALBA_PRINT_OUTPUT_STREAM << "ALBA_PRINT1 in " << __FUNCTION__ << "(...): " << Z_ALBA_PRIVATE_GET_STRING_PRINT1(__VA_ARGS__) << endl#define ALBA_PRINT2(...) ALBA_PRINT_OUTPUT_STREAM << "ALBA_PRINT2 in " << __FUNCTION__ << "(...): " << Z_ALBA_PRIVATE_GET_STRING_PRINT2(__VA_ARGS__) << endl
#define ALBA_PRINT3(...) ALBA_PRINT_OUTPUT_STREAM << "ALBA_PRINT3 in " << __FUNCTION__ << "(...): " << Z_ALBA_PRIVATE_GET_STRING_PRINT3(__VA_ARGS__) << endl
#define ALBA_PRINT4(...) ALBA_PRINT_OUTPUT_STREAM << "ALBA_PRINT4 in " << __FUNCTION__ << "(...): " << Z_ALBA_PRIVATE_GET_STRING_PRINT4(__VA_ARGS__) << endl
#define ALBA_PRINT5(...) ALBA_PRINT_OUTPUT_STREAM << "ALBA_PRINT5 in " << __FUNCTION__ << "(...): " << Z_ALBA_PRIVATE_GET_STRING_PRINT5(__VA_ARGS__) << endl#define ALBA_PRINT6(...) ALBA_PRINT_OUTPUT_STREAM << "ALBA_PRINT6 in " << __FUNCTION__ << "(...): " << Z_ALBA_PRIVATE_GET_STRING_PRINT6(__VA_ARGS__) << endl

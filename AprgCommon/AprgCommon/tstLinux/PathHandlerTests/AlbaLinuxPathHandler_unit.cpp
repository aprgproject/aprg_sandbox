...
#include <PathHandlers/AlbaLinuxPathHandler.hpp>
...
{
    AlbaLinuxPathHandler pathHandler(APRG_DIR R"(////AprgCommon\\\\/AprgCommon/tst\FilesForTests\)");
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon\AprgCommon\tst\FilesForTests\)"), pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_TRUE(pathHandler.getExtension().empty());
...
{
    AlbaLinuxPathHandler pathHandler(R"(/APRG12345/Aprg!@#$%Common/AprgCommon/tst/)");    EXPECT_EQ(R"(/APRG12345/Aprg!@#$%Common/AprgCommon/tst/)", pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
...
{
    AlbaLinuxPathHandler pathHandler(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File1.log)");
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/)"), pathHandler.getDirectory());
    ...
    pathHandler.input(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/thisFileDoesNotExist.txt)");
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/)"), pathHandler.getDirectory());
    ...
    pathHandler.input(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests)");
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/)"), pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_TRUE(pathHandler.getExtension().empty());
...
{
    string const pathOfFileToBeDeleted(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/FileToBeDeleted.log)");
...
{
    string const pathOfFileToBeRenamed(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/FileToBeRenamed.log)");
...
{
    string const pathOfFileToBeCopied(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/FileToBeCopied.log)");
    ...
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/)"), pathHandlerOfCopiedFile.getDirectory());
...
{
    string const pathOfDirectoryToBeRenamed(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR1)");

    AlbaLinuxPathHandler pathHandler(pathOfDirectoryToBeRenamed);
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR1/)"),  pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_TRUE(pathHandler.getExtension().empty());
    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
    ...
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/RenamedDirectory/)"), pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_TRUE(pathHandler.getExtension().empty());
    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
...
{
    AlbaLinuxPathHandler pathHandler(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/)");
    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
    ...
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File1.log)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File2.txt)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File4.mp3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File5.avi)"), *(itFiles++));
    ASSERT_EQ(6U, listOfDirectory.size());
    auto itDirectories = listOfDirectory.begin();
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR1/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR2/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR3/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR4/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR5/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR6/)"), *(itDirectories++));
}
...
TEST_F(AlbaLinuxPathHandlerTest, FullPathWithDirectory_FindFileAndDirectoryMultipleDepthTwo)
{
    ...
    auto itFiles = listOfFiles.begin();
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR1/File1.log)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR2/File2.txt)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR3/File3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR4/File4.mp3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR5/File5.avi)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File1.log)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File2.txt)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File4.mp3)"), *(itFiles++));
    ...
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR5/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR6/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR6/SUBDIR1/)"), *(itDirectories++));
}
...
TEST_F(AlbaLinuxPathHandlerTest, FullPathWithDirectory_FindFileAndDirectoryUnlimitedDepth)
{
    ...
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR4/File4.mp3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR5/File5.avi)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/DIR6/SUBDIR1/File6.jpg)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File1.log)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File2.txt)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(AprgCommon/AprgCommon/tst/FilesForTests/DirectoryTest/File4.mp3)"), *(itFiles++));

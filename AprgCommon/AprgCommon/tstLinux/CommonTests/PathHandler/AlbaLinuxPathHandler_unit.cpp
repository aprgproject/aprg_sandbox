...
{
    AlbaLinuxPathHandler pathHandler(APRG_DIR R"(\AprgCommon\AprgCommon\tst\CommonTests/FilesForTests\)");
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon\AprgCommon\tst\CommonTests/FilesForTests\)"), pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_TRUE(pathHandler.getExtension().empty());    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
}

TEST_F(AlbaLinuxPathHandlerTest, FullPathWithOnlyDirectoryGiven_JumbledSlashes)
{
    AlbaLinuxPathHandler pathHandler(APRG_DIR R"(\////AprgCommon\\\\/AprgCommon/tst\CommonTests/FilesForTests\)");
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon\AprgCommon\tst\CommonTests/FilesForTests\)"), pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_TRUE(pathHandler.getExtension().empty());    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
...
{
    AlbaLinuxPathHandler pathHandler(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File1.log)");
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/)"), pathHandler.getDirectory());
    EXPECT_EQ("File1.log", pathHandler.getFile());
    EXPECT_EQ("File1", pathHandler.getFilenameOnly());
    EXPECT_EQ("log", pathHandler.getExtension());    EXPECT_EQ(PathType::File, pathHandler.getPathType());
    EXPECT_TRUE(pathHandler.isFoundInLocalSystem());

    pathHandler.input(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/thisFileDoesNotExist.txt)");
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/)"), pathHandler.getDirectory());
    ...
    pathHandler.input(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests)");
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/)"), pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_TRUE(pathHandler.getExtension().empty());    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
...
{
    string const pathOfFileToBeDeleted(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/FileToBeDeleted.log)");
    std::ofstream fileToBeDeleted(pathOfFileToBeDeleted);
    fileToBeDeleted.close();

    AlbaLinuxPathHandler pathHandler(pathOfFileToBeDeleted);
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/)"), pathHandler.getDirectory());
...
{
    string const pathOfFileToBeRenamed(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/FileToBeRenamed.log)");
    std::ofstream fileToBeDeleted(pathOfFileToBeRenamed);
    fileToBeDeleted.close();

    AlbaLinuxPathHandler pathHandler(pathOfFileToBeRenamed);
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/)"), pathHandler.getDirectory());
...
{
    string const pathOfFileToBeCopied(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/FileToBeCopied.log)");
    string const pathOfCopiedFile("CopiedFile.log");
    std::ofstream fileToBeDeleted(pathOfFileToBeCopied);
    fileToBeDeleted.close();

    AlbaLinuxPathHandler pathHandler(pathOfFileToBeCopied);
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/)"), pathHandler.getDirectory());
    ...
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/)"), pathHandlerOfCopiedFile.getDirectory());
    EXPECT_EQ("CopiedFile.log", pathHandlerOfCopiedFile.getFile());
    EXPECT_EQ("CopiedFile", pathHandlerOfCopiedFile.getFilenameOnly());
    EXPECT_EQ("log", pathHandlerOfCopiedFile.getExtension());    EXPECT_EQ(PathType::File, pathHandlerOfCopiedFile.getPathType());
    EXPECT_TRUE(pathHandlerOfCopiedFile.isFoundInLocalSystem());

    EXPECT_TRUE(pathHandler.deleteFile());    EXPECT_TRUE(pathHandlerOfCopiedFile.deleteFile());
}

TEST_F(AlbaLinuxPathHandlerTest, ReInputDirectoryThatIsToBeRenamed_ActualLocalDirectory)
{
    string const pathOfDirectoryToBeRenamed(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR1)");

    AlbaLinuxPathHandler pathHandler(pathOfDirectoryToBeRenamed);
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR1/)"),  pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_TRUE(pathHandler.getExtension().empty());    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
    EXPECT_TRUE(pathHandler.isFoundInLocalSystem());
    ...
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/RenamedDirectory/)"), pathHandler.getDirectory());
    EXPECT_TRUE(pathHandler.getFile().empty());
    EXPECT_TRUE(pathHandler.getFilenameOnly().empty());
    EXPECT_TRUE(pathHandler.getExtension().empty());    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
    EXPECT_TRUE(pathHandler.isFoundInLocalSystem());
...
{
    AlbaLinuxPathHandler pathHandler(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/)");
    EXPECT_EQ(PathType::Directory, pathHandler.getPathType());
    ...
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File1.log)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File2.txt)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File4.mp3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File5.avi)"), *(itFiles++));
    ASSERT_EQ(6U, listOfDirectory.size());
    auto itDirectories = listOfDirectory.begin();
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR1/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR2/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR3/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR4/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR5/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR6/)"), *(itDirectories++));
}
...
TEST_F(AlbaLinuxPathHandlerTest, FullPathWithDirectory_FindFileAndDirectoryMultipleDepthTwo)
{
    ...
    auto itFiles = listOfFiles.begin();
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR1/File1.log)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR2/File2.txt)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR3/File3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR4/File4.mp3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR5/File5.avi)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File1.log)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File2.txt)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File4.mp3)"), *(itFiles++));
    ...
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR5/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR6/)"), *(itDirectories++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR6/SUBDIR1/)"), *(itDirectories++));
}
...
TEST_F(AlbaLinuxPathHandlerTest, FullPathWithDirectory_FindFileAndDirectoryUnlimitedDepth)
{
    ...
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR4/File4.mp3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR5/File5.avi)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/DIR6/SUBDIR1/File6.jpg)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File1.log)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File2.txt)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File3)"), *(itFiles++));
    EXPECT_EQ(convertToSimplestPath(APRG_DIR R"(\AprgCommon/AprgCommon/tst/CommonTests/FilesForTests/DirectoryTest/File4.mp3)"), *(itFiles++));
...
{
    AlbaLinuxPathHandler pathHandler(PathInitialValueSource::DetectedLocalPath);

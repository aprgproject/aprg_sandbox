...
AlbaNumber getLimitAtAValueInThePositiveSide(
    ...
    return getLimitAtAValueByIterationAndLinearInterpolation(
        term, variableName, valueToApproach, valueToApproach + POSITIVE_DELTA_FOR_INITIAL_VALUE,
...
AlbaNumber getLimitAtAValueByIterationAndLinearInterpolation(
    ...
    return getLimitAtAValueUsingTrendOfValues(
        term, variableName, valueToApproach, previousAcceptedInput, previousOfPreviousAcceptedInput);
}
...
Term getLimit(Term const& term, string const& variableName, AlbaNumber const& valueToApproach) {

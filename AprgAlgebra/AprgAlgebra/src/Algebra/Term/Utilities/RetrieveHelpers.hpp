...
void retrieveNumbers(AlbaNumbersSet & numbers, Monomial const& monomial);void retrieveNumbers(AlbaNumbersSet & numbers, Polynomial const& polynomial);
...
void retrieveVariableNames(VariableNamesSet & variableNames, Monomial const& monomial);void retrieveVariableNames(VariableNamesSet & variableNames, Polynomial const& polynomial);

...
SummationSeriesOfArithmeticSeries::SummationSeriesOfArithmeticSeries(
    ...
    : SeriesBasedOnSummation(
          ArithmeticSeries(firstValue, commonDifference).getFormulaForSeries(),
          n)
{}
...
SummationSeriesOfArithmeticSeries::SummationSeriesOfArithmeticSeries(
        ...
        int const nthIndex2)
    : SeriesBasedOnSummation(
          ArithmeticSeries(valueAtNthIndex1, nthIndex1, valueAtNthIndex2, nthIndex2).getFormulaForSeries(),
          n)
{}

...
void SignMutator::putVariableWithSign(string const& variableName, TermAssociationType const association) {
...
void SignMutator::mutateExpressionWithMultiplicationAndDivision(Expression& expression) {

...
{}
template TermsRaiseToExponents<AlbaNumber, TermRaiseToANumber>::TermsRaiseToExponents(BaseToExponentMap const& baseToExponentMap);
template TermsRaiseToExponents<Term, TermRaiseToTerms>::TermsRaiseToExponents(BaseToExponentMap const& baseToExponentMap);
...
template <typename ExponentType, typename BaseRaiseToExponentType>
ExponentType TermsRaiseToExponents<ExponentType, BaseRaiseToExponentType>::getExponentOfBase(
...
template <typename ExponentType, typename BaseRaiseToExponentType>
TermsWithDetails TermsRaiseToExponents<ExponentType, BaseRaiseToExponentType>::getTermWithDetailsInMultiplicationAndDivisionOperation() const
{
...
template TermsWithDetails TermsRaiseToExponents<AlbaNumber, TermRaiseToANumber>::getTermWithDetailsInMultiplicationAndDivisionOperation() const;
template TermsWithDetails TermsRaiseToExponents<Term, TermRaiseToTerms>::getTermWithDetailsInMultiplicationAndDivisionOperation() const;
...
template void TermsRaiseToExponents<Term, TermRaiseToTerms>::addExponents(TermsRaiseToExponents<Term, TermRaiseToTerms> const& termsRaiseToNumbers);
...
template void TermsRaiseToExponents<Term, TermRaiseToTerms>::subtractExponents(TermsRaiseToExponents<Term, TermRaiseToTerms> const& termsRaiseToNumbers);


template <typename ExponentType, typename BaseRaiseToExponentType>
void TermsRaiseToExponents<ExponentType, BaseRaiseToExponentType>::multiplyToExponents(
        ExponentType const& exponent)
{
...
template void TermsRaiseToExponents<AlbaNumber, TermRaiseToANumber>::putTerm(Term const& term, TermAssociationType const association);
template void TermsRaiseToExponents<Term, TermRaiseToTerms>::putTerm(Term const& term, TermAssociationType const association);
...
template void TermsRaiseToExponents<AlbaNumber, TermRaiseToANumber>::putTerms(Terms const& terms, TermAssociationType const association);
template void TermsRaiseToExponents<Term, TermRaiseToTerms>::putTerms(Terms const& terms, TermAssociationType const association);
...
template void TermsRaiseToExponents<AlbaNumber, TermRaiseToANumber>::setBaseAndExponent(Term const& base, AlbaNumber const& exponent);
template void TermsRaiseToExponents<Term, TermRaiseToTerms>::setBaseAndExponent(Term const& base, Term const& exponent);


template <typename ExponentType, typename BaseRaiseToExponentType>
void TermsRaiseToExponents<ExponentType, BaseRaiseToExponentType>::removeItemWithBase(
        Term const& base)
{
...
Term TermsRaiseToExponents<ExponentType, BaseRaiseToExponentType>::convertToTerm(
        Term const& base,
        ExponentType const& exponent) const
{
    Term result;
...
template <typename ExponentType, typename BaseRaiseToExponentType>void TermsRaiseToExponents<ExponentType, BaseRaiseToExponentType>::putTermUsingBaseToExponentType(
        Term const& term,
        int const sign)
{}
template <>
void TermsRaiseToExponents<AlbaNumber, TermRaiseToANumber>::putTermUsingBaseToExponentType(Term const& term, int const sign)
{

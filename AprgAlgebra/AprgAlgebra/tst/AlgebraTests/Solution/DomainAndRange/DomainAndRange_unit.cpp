...
TEST(DomainAndRangeTest, CalculateDomainUsingTransitionValuesWorksWithFunctionWithNanValues) {    AlbaNumbers values{3};
...
TEST(DomainAndRangeTest, CalculateDomainForTermWithOneVariableWorksWithTermWithValues) {    AlbaNumbers values{1.3, 9.25};
...
TEST(DomainAndRangeTest, CalculateDomainForTermWithOneVariableWorksWithConstant) {    SolutionSet actualDomain = calculateDomainForTermWithOneVariable(5);
...
TEST(DomainAndRangeTest, CalculateDomainForTermWithOneVariableWorksWithTerm) {    Polynomial polynomial{Monomial(4, {}), Monomial(-1, {{"x", 2}})};
    Expression expression(createExpressionIfPossible({polynomial, "^", AlbaNumber::createFraction(1, 2)}));
...
TEST(DomainAndRangeTest, CalculateDomainForTermWithOneVariableWorksWithTermWithExample1) {    Polynomial polynomial{Monomial(1, {{"x", 2}}), Monomial(-2, {{"x", 1}})};
    Expression expression(createExpressionIfPossible({polynomial, "^", AlbaNumber::createFraction(1, 2)}));
...
TEST(DomainAndRangeTest, CalculateDomainForEquationWorksWithEquationWithValues) {    Polynomial polynomialLeft{Monomial(1, {{"x", 2}}), Monomial(1, {{"y", 2}})};
...
TEST(DomainAndRangeTest, CalculateDomainForEquationWorksWithEquation) {    Polynomial polynomialLeft{Monomial(1, {{"x", 2}}), Monomial(1, {{"y", 2}})};
    Equation equation(polynomialLeft, "=", 36);
...
TEST(DomainAndRangeTest, CalculateDomainForEquationWorksWithEquationUsingExample1) {    Equation equation("y", "=", Monomial(1, {{"x", 2}}));
...
TEST(DomainAndRangeTest, CalculateDomainForEquationWorksWithSquareRootOfQuadratic) {    Polynomial quadratic{Monomial(9, {}), Monomial(-1, {{"x", 2}})};
...
TEST(DomainAndRangeTest, CalculateDomainForEquationWorksWith2AbsoluteValues) {    Function absoluteValueOfX(Functions::abs(createExpressionIfPossible({"x"})));
...
TEST(DomainAndRangeTest, CalculateDomainForEquationWorksWithXToTheXIsWrong) {    Expression leftHandExpression(createExpressionIfPossible({"x", "^", "x", "-", 823543}));
...
TEST(DomainAndRangeTest, CalculateRangeForEquationWorksWithEquationWithValues) {    Polynomial polynomialLeft{Monomial(1, {{"x", 2}}), Monomial(1, {{"y", 2}})};
    Equation equation(polynomialLeft, "=", 36);
    AlbaNumbers numbers{3.3, 9.9};
...
TEST(DomainAndRangeTest, CalculateRangeForEquationWorksWithEquation) {    Polynomial polynomialLeft{Monomial(1, {{"x", 2}}), Monomial(1, {{"y", 2}})};
    Equation equation(polynomialLeft, "=", 36);
...
TEST(DomainAndRangeTest, CalculateRangeForEquationWorksWithEquationUsingExample1) {    Equation equation("y", "=", Monomial(1, {{"x", 2}}));
...
TEST(DomainAndRangeTest, CalculateRangeForEquationWorksWith2AbsoluteValues) {    Function absoluteValueOfX(Functions::abs(createExpressionIfPossible({"x"})));
    Function absoluteValueOfY(Functions::abs(createExpressionIfPossible({"y"})));
    Expression leftHandExpression(createExpressionIfPossible({absoluteValueOfX, "+", absoluteValueOfY}));
    Equation equation(leftHandExpression, "=", 1);
    SolutionSet actualRange = calculateRangeForEquation("x", equation);
...
TEST(DomainAndRangeTest, AppendTransitionValuesWorks) {    AlbaNumbersSet collectedValues;

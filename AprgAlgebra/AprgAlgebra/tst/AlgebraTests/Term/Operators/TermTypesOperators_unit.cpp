...
TEST(TermTypesOperatorsTest, BinaryPlusOperator_PolynomialAddFunctionOperationWorks)
{
    ...
    Expression expressionToExpect(                createExpressionIfPossible({Polynomial{Monomial(5, {}), Monomial(1, {{"x", 1}})}, "+", absoluteValueFunction}));
    EXPECT_EQ(Term(expressionToExpect), term);
}
...
TEST(TermTypesOperatorsTest, BinaryPlusOperator_ExpressionAddFunctionOperationWorks)
{
    ...
    Expression expressionToExpect(                createExpressionIfPossible({createExpressionIfPossible({54}), "+", absoluteValueFunction}));
    EXPECT_EQ(Term(expressionToExpect), term);
}
...
TEST(TermTypesOperatorsTest, BinaryPlusOperator_FunctionAddPolynomialOperationWorks)
{
    ...
    Expression expressionToExpect(                createExpressionIfPossible({absoluteValueFunction, "+", Polynomial{Monomial(5, {}), Monomial(1, {{"x", 1}})}}));
    EXPECT_EQ(Term(expressionToExpect), term);
}
...
TEST(TermTypesOperatorsTest, BinaryPlusOperator_FunctionAddExpressionOperationWorks)
{
    ...
    Expression expressionToExpect(                createExpressionIfPossible({absoluteValueFunction, "+", createExpressionIfPossible({54})}));
    EXPECT_EQ(Term(expressionToExpect), term);
}

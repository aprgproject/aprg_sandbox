...
TEST(ProofByInductionTest, ProveTheSumOfOddIntegers)
{
    ...
    ProofByInduction proof("n", Term(Monomial(1, {{"n", 2}})), [](AlbaNumber const& n)
    {
        AlbaNumber result(0);
    ...
    SubstitutionOfVariablesToTerms substitutionForNextTerm{{"n", Term(Polynomial{Monomial(1, {{"n", 1}}), Monomial(1, {})})}};

...
{
    Equation equation(Term("y"), "=", Term(Monomial(1, {{"x", 2}})));
...
{
    AlbaNumbersSet collectedValues;    AlbaNumbersSet sortedValues{5, 9.25};
...
{
    Equation equation1(Term("y"), "=", Term(Monomial(1, {{"x", 2}})));
    Equation equation2(Term("y"), "=", Term(Monomial(1, {{"x", 3}})));

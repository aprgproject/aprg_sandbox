...
{    // Evaluate the double integral Integral[3y-2*x^2]dA
    ...
    DetailsForDefiniteIntegralWithTerms xDetails{"x", Term(-1), Term(2)};
...
TEST(IntegrationGeometryUtilitiesTest, GetDoubleIntegralInCartesianCoordinatesWorksOnExample2)
{
    ...
    DetailsForDefiniteIntegralWithTerms xDetails{"x", Term(0), Term(3)};
...
TEST(IntegrationGeometryUtilitiesTest, GetCenterOfMassOfALaminaWorksWithXDetailsAndYDetails)
{
    ...
    EXPECT_EQ(termToExpect1, termPairToVerify.first);    EXPECT_EQ(termToExpect2, termPairToVerify.second);
}
...
TEST(IntegrationGeometryUtilitiesTest, GetRadiusOfGyrationWorksWithXDetailsAndYDetails)
{
    ...
    Term termToExpect(0.6324555320336759);    EXPECT_EQ(termToExpect, termToVerify);
}
...
TEST(IntegrationGeometryUtilitiesTest, GetDoubleIntegralInPolarCoordinatesWorksOnExample1)
{
    ...
    Term termToTest("r");
    DetailsForDefiniteIntegralWithTerms radiusDetails{"r", Term(0), Term(3)*Term(sin(Term("theta")))};
...
TEST(IntegrationGeometryUtilitiesTest, GetDoubleIntegralInPolarCoordinatesWorksOnExample2)
{
    ...
    Term termToTest(1);
    DetailsForDefiniteIntegralWithTerms radiusDetails{"r", Term(0), Term(sin(Term(Monomial(3, {{"theta", 1}}))))};
...
TEST(IntegrationGeometryUtilitiesTest, DISABLED_GetSurfaceAreaWithZInCartesianCoordinatesWorksOnExample1)
{
    ...
    DetailsForDefiniteIntegralWithTerms xDetails{"x", Term(0), Term(2)};
...
TEST(IntegrationGeometryUtilitiesTest, GetTripleIntegralInCartesianCoordinatesWorks)
{
    ...
    DetailsForDefiniteIntegralWithTerms xDetails{"x", Term(0), Term(2)};
    DetailsForDefiniteIntegralWithTerms yDetails{"y", Term(0), Term(createExpressionIfPossible(
...
TEST(IntegrationGeometryUtilitiesTest, GetTripleIntegralInCylindricalCoordinatesWorks)
{
    ...
    Term termToTest(1);
    DetailsForDefiniteIntegralWithTerms radiusDetails{"r", Term(0), Term(2)};
    DetailsForDefiniteIntegralWithTerms thetaDetails{"theta", Term(0), getPiAsTerm()*Term(2)};
...
TEST(IntegrationGeometryUtilitiesTest, GetTripleIntegralInSphericalCoordinatesWorks)
{
    ...
    DetailsForDefiniteIntegralWithTerms rawDetails{"raw", Term(0), Term(2)};
    DetailsForDefiniteIntegralWithTerms thetaDetails{"theta", Term(0), getPiAsTerm()/Term(2)};

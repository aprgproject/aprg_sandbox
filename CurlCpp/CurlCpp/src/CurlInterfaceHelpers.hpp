...
bool downloadForOutputFileStream(string url, ofstream& outputFile, function<void(curl_easy&)> additionalConfig);bool downloadWithAdditionalConfig(string const& url, string const& fileLocation, function<void(curl_easy&)> additionalConfig);
...
bool downloadAsBinaryWithAdditionalConfigUntilSuccessful(string const& url, string const& fileLocation, function<void(curl_easy&)> additionalConfig);bool downloadAsBinaryWithAdditionalConfigWithFiniteNumberOfTries(
        string const& url,

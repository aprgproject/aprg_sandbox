...
Section "TcomTools files" TcomToolsFilesSection
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_TcomToolsFilesSection ${LANG_ENGLISH} "TcomTools file section."

  ;Assign language strings to sections
  !insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
    !insertmacro MUI_DESCRIPTION_TEXT ${TcomToolsFilesSection} $(DESC_TcomToolsFilesSection)

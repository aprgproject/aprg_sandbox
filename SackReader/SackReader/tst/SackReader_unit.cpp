...
TEST(SackReaderTest, DISABLED_CheckAllFiles)
{
    ...
    sackReader.gatherAllFiles();    EXPECT_EQ(R"(C:\APRG\SackReader\SackReader\SampleFiles\oam_tcom.h)", sackReader.getFileFullPath("oam_tcom.h"));
}
...
TEST(RealTest, DISABLED_UpdateTrunkFiles)
{
    ...
    sackReader.gatherAllFiles();    sackReader.readFilesNeededForIfs();
    ...
    sackReader.generateLyxDocument(R"(D:\Specifications\OAM-TCOM-IFS\OAM_CPLANE_IFS_template.lyx)", R"(D:\Specifications\OAM-TCOM-IFS\OAM_CPLANE_IFS_TEST.lyx)");

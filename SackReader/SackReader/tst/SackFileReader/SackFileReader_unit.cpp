...
TEST(SackFileReaderTest, DISABLED_Constants)
{
    ...
    EXPECT_EQ("3GPP 10 Nokia 2.", details.description);    EXPECT_EQ("2", details.value);
...
TEST(SackFileReaderTest, DISABLED_DTechLogDef)
{
    ...
    EXPECT_EQ("", details.description);    EXPECT_EQ("48", details.value);
...
TEST(SackFileReaderTest, DISABLED_CommentInStructure)
{
    ...
    EXPECT_EQ("numberOfHsPdsch", details.name);    EXPECT_EQ("TNumberOfItems", details.type);
...
TEST(SackFileReaderTest, DISABLED_OamTupcStructures)
{
    ...
    EXPECT_EQ("typeOfConfiguration", details.name);    EXPECT_EQ("EControlUnitType", details.type);
    EXPECT_FALSE(details.isAnArray);
    EXPECT_EQ("", details.description);
...
TEST(SackFileReaderTest, DISABLED_OamTcomStructures)
{
    ...
    EXPECT_EQ("btsomTelecomServiceAddr", details.name);    EXPECT_EQ("SMessageAddress", details.type);
    EXPECT_FALSE(details.isAnArray);
    EXPECT_EQ("", details.description);
...
TEST(SackFileReaderTest, DISABLED_SWamUnit)
{
    ...
    EXPECT_EQ("logUnitAddr", details.name);    EXPECT_EQ("TBoard", details.type);
    EXPECT_FALSE(details.isAnArray);
...
TEST(SackFileReaderTest, DISABLED_EHspaMapping)
{
    ...
    EXPECT_EQ("EHspaMapping_EmptyValue", details.name);    EXPECT_EQ("0", details.value);
...
TEST(SackFileReaderTest, DISABLED_EControlUnitType)
{
    ...
    EXPECT_EQ("EControlUnitType_Fcm", details.name);    EXPECT_EQ("1", details.value);
...
TEST(SackFileReaderTest, DISABLED_UConfigInfoElement)
{
    ...
    EXPECT_EQ("wamUnit", details.name);    EXPECT_EQ("SWamUnit", details.type);
    EXPECT_FALSE(details.isAnArray);
...
TEST(SackFileReaderTest, DISABLED_UIpMacAddress)
{
    ...
    EXPECT_EQ("ipMacv4", details.name);    EXPECT_EQ("SIpMacAddressV4", details.type);
    EXPECT_FALSE(details.isAnArray);
...
TEST(SackFileReaderTest, DISABLED_URxAntennaBusParameters)
{
    ...
    EXPECT_EQ("paramsForRfBus", details.name);    EXPECT_EQ("SAntennaBusParametersForRfBus", details.type);
    EXPECT_FALSE(details.isAnArray);
...
TEST(SackFileReaderTest, DISABLED_TAichPower)
{
    ...
    EXPECT_EQ("TAichPower", details.name);    EXPECT_EQ("i32", details.typedefDerivedName);
...
TEST(SackFileReaderTest, DISABLED_TSubrackNbr)
{
    ...
    EXPECT_EQ("TSubrackNbr", details.name);    EXPECT_EQ("u32", details.typedefDerivedName);
    EXPECT_EQ("", details.description);
}
...
TEST(SackFileReaderTest, DISABLED_TSubunits)
{
    ...
    EXPECT_EQ("TSubunits", details.name);    EXPECT_EQ("r32", details.typedefDerivedName);

...
macro(MACRO_GET_ALL_SUBDIRECTORIES currentDirectory result)
    unset(${result})
    MACRO_GET_ALL_SUBDIRECTORIES_RECURSIVE(${currentDirectory} ${result})    #message(STATUS "MACRO_GET_ALL_SUBDIRECTORIES result: ${${result}}")
endmacro()
...
macro(MACRO_GET_SOURCES_FROM_LIST subDirectories result)
    unset(${result})
    #message(STATUS "MACRO_GET_SOURCES_FROM_LIST subDirectories: ${subDirectories}")    foreach(subDirectory ${subDirectories})

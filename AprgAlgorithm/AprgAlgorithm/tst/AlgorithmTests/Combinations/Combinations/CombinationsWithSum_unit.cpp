...
TEST(CombinationsWithSumUsingRecursionTest, GetCombinationsWithSumUsingRecursionWorks)
{
...
TEST(CombinationsWithSumUsingRecursionTest, GetCombinationsWithSumUsingLoopsWorks)
{
    Values inputValues{1U, 2U, 3U, 4U};
    GenerationForTest generation(inputValues);

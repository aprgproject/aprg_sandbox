...
TEST(PathSearchUsingFloydWarshallTest, ShortestPathSearchEndsWhenThereAreNegativeCycles_AndDoesNotWork)
{
    EdgeWeightedDirectedGraphForTest graph;
    graph.connect(0U, 1U, -0.26);
    graph.connect(1U, 2U, -0.38);
    ...
    EXPECT_FALSE(pathSearch.hasPathTo(0U, 4U));
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 0U));
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 1U));
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 2U));
    EXPECT_EQ(PathForTest({0U, 2U, 3U}), pathSearch.getPathTo(0U, 3U));
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 4U));
}

TEST(PathSearchUsingFloydWarshallTest, LongestPathSearchEndsWhenThereArePositiveCycles_AndDoesNotWork)
{
    EdgeWeightedDirectedGraphForTest graph;
    graph.connect(0U, 1U, 0.26);
    graph.connect(1U, 2U, 0.38);
...
TEST(PathSearchUsingFloydWarshallTest, LongestPathSearchEndsWhenThereAreNegativeCycles)
{
    EdgeWeightedDirectedGraphForTest graph;
    graph.connect(0U, 1U, -0.26);
    graph.connect(1U, 2U, -0.38);
...
TEST(PathSearchUsingFloydWarshallTest, GetPathToWorksWithEdgeWeightedDirectedGraphAndLesserComparison)
{
    ...
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 5U));
...
TEST(PathSearchUsingFloydWarshallTest, GetPathToWorksWithEdgeWeightedDirectedGraphAndGreaterComparison)
{
    ...
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 1U));
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 2U));
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 3U));
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 4U));
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 5U));
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 6U));
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 7U));
    EXPECT_EQ(PathForTest(), pathSearch.getPathTo(0U, 8U));
}

...
TEST(VertexOrderingUsingDfsTest, VertexOrderingWorksUsingExample1WithDirectedGraph){
    ...
    VerticesForTest expectedPostOrderVertices{10U, 20U, 11U, 21U, 12U, 22U, 13U, 23U, 30U, 31U, 32U, 33U, 40U};    VerticesForTest expectedReversePostOrderVertices{40U, 33U, 32U, 31U, 30U, 23U, 13U, 22U, 12U, 21U, 11U, 20U, 10U};
...
TEST(VertexOrderingUsingDfsTest, VertexOrderingWorksUsingExample2WithDirectedGraph)
{
    ...
    VerticesForTest expectedPostOrderVertices{1U, 4U, 5U, 10U, 12U, 11U, 9U, 6U, 0U, 3U, 2U, 7U, 8U};    VerticesForTest expectedReversePostOrderVertices{8U, 7U, 2U, 3U, 0U, 6U, 9U, 11U, 12U, 10U, 5U, 4U, 1U};
    EXPECT_EQ(expectedPreOrderVertices, preOrderVerticesToVerify);
    EXPECT_EQ(expectedPostOrderVertices, postOrderVerticesToVerify);
    EXPECT_EQ(expectedReversePostOrderVertices, reversePostOrderVerticesToVerify);}

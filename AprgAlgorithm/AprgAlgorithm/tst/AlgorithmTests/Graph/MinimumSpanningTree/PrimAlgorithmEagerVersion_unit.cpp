...
#include <Algorithm/Graph/MinimumSpanningTree/PrimAlgorithmEagerVersion.hpp>
...
using MinimumSpanningTreeSearchForTest = PrimAlgorithmEagerVersion<Vertex, double, EdgeWeightedUndirectedGraphForTest>;

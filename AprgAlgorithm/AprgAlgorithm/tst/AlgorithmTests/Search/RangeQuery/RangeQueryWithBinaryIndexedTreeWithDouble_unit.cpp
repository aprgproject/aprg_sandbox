...
TEST(RangeQueryWithBinaryIndexedTreeTest, GetAccumulatedValueOnIntervalWithGeometricSumWorksOnExample1)
{
    ...
    EXPECT_DOUBLE_EQ(1, geometricSumRangeQuery.getAccumulatedValueOnInterval(0, 0));    EXPECT_DOUBLE_EQ(3, geometricSumRangeQuery.getAccumulatedValueOnInterval(0, 1));
    ...
    EXPECT_DOUBLE_EQ(48, geometricSumRangeQuery.getAccumulatedValueOnInterval(3, 4));    EXPECT_DOUBLE_EQ(6, geometricSumRangeQuery.getAccumulatedValueOnInterval(4, 4));
}
...
TEST(RangeQueryWithBinaryIndexedTreeTest, GetSumFrom0ToIndexWithGeometricSumWorksOnExample1)
{
    ...
    EXPECT_DOUBLE_EQ(1, geometricSumRangeQuery.getAccumulatedValueFrom0ToIndex(0));    EXPECT_DOUBLE_EQ(3, geometricSumRangeQuery.getAccumulatedValueFrom0ToIndex(1));
...
TEST(RangeQueryWithBinaryIndexedTreeTest, ChangeValueAtIndexWithGeometricSumWorksOnExample1)
{
    ...
    EXPECT_DOUBLE_EQ(12, geometricSumRangeQuery.getAccumulatedValueOnInterval(0, 2));    EXPECT_DOUBLE_EQ(36, geometricSumRangeQuery.getAccumulatedValueOnInterval(0, 3));
    ...
    EXPECT_DOUBLE_EQ(18, geometricSumRangeQuery.getAccumulatedValueOnInterval(3, 4));    EXPECT_DOUBLE_EQ(6, geometricSumRangeQuery.getAccumulatedValueOnInterval(4, 4));
}

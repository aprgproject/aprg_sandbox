...
TEST(RangeQueryWithSegmentTreeTest, GetAccumulatedValueOnIntervalWithGeometricSumWorksOnExample1)
{
    ...
    EXPECT_DOUBLE_EQ(1, geometricSumRangeQuery.getValueOnInterval(0, 0));    EXPECT_DOUBLE_EQ(3, geometricSumRangeQuery.getValueOnInterval(0, 1));
    ...
    EXPECT_DOUBLE_EQ(48, geometricSumRangeQuery.getValueOnInterval(3, 4));    EXPECT_DOUBLE_EQ(6, geometricSumRangeQuery.getValueOnInterval(4, 4));
}
...
TEST(RangeQueryWithSegmentTreeTest, ChangeValueAtIndexWithGeometricSumWorksOnExample1)
{
    ...
    EXPECT_DOUBLE_EQ(12, geometricSumRangeQuery.getValueOnInterval(0, 2));    EXPECT_DOUBLE_EQ(36, geometricSumRangeQuery.getValueOnInterval(0, 3));
    ...
    EXPECT_DOUBLE_EQ(18, geometricSumRangeQuery.getValueOnInterval(3, 4));    EXPECT_DOUBLE_EQ(6, geometricSumRangeQuery.getValueOnInterval(4, 4));
}

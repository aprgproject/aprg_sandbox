...
TEST(RangeQueryWithSegmentTreeTest, GetValueOnIntervalWithMinimumWorksInExample1)
{
    ...
    EXPECT_EQ(5U, minimumRangeQuery.getValueOnInterval(0U, 0U));    EXPECT_EQ(5U, minimumRangeQuery.getValueOnInterval(0U, 1U));
...
TEST(RangeQueryWithSegmentTreeTest, GetValueOnIntervalWithMaximumWorksInExample1)
{
    ...
    EXPECT_EQ(5U, maximumRangeQuery.getValueOnInterval(0U, 0U));    EXPECT_EQ(9U, maximumRangeQuery.getValueOnInterval(0U, 1U));
...
TEST(RangeQueryWithSegmentTreeTest, GetValueOnIntervalWithSumWorksOnExample1)
{
    ...
    EXPECT_EQ(1U, sumRangeQuery.getValueOnInterval(0U, 0U));    EXPECT_EQ(4U, sumRangeQuery.getValueOnInterval(0U, 1U));
    ...
    EXPECT_EQ(14U, sumRangeQuery.getValueOnInterval(3U, 4U));    EXPECT_EQ(6U, sumRangeQuery.getValueOnInterval(4U, 4U));
}
...
TEST(RangeQueryWithSegmentTreeTest, ChangeValueAtIndexWithSumWorksOnExample1)
{
    ...
    EXPECT_EQ(9U, sumRangeQuery.getValueOnInterval(3U, 4U));    EXPECT_EQ(6U, sumRangeQuery.getValueOnInterval(4U, 4U));
}

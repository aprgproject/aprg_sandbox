...
TEST(TwoSumTest, GetPossibleDuplicatedTwoValuesWithSumWithIndicesWorksOnExample1)
{
    ValuesForTest sortedValues{1U, 4U, 5U, 6U, 7U, 9U, 10U};
    SumSearch search(sortedValues);
...
TEST(TwoSumTest, GetPossibleDuplicatedTwoValuesWithSumWithIndicesDoesNotWorkOnExample1)
{
    ValuesForTest sortedValues{1U, 4U, 5U, 6U, 7U, 9U, 10U};
    SumSearch search(sortedValues);

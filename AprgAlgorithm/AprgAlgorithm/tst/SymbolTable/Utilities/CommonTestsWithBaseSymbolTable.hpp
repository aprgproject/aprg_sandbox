...
void performIsEmptyTestWhenEmpty(BaseSymbolTableForUnsignedInt & symbolTable);void performIsEmptyTestWhenNotEmpty(BaseSymbolTableForUnsignedInt & symbolTable);

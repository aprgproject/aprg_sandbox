...
{
    Implicant implicant;
    implicant.addMinterm(8);    implicant.addMinterm(10);
...
TEST(QuineMcCluskeyTest, ImplicantCompatibilityTest)
{
    ...
    implicant1.addMinterm(4);    implicant1.addMinterm(12);
    Implicant implicant2;
    implicant2.addMinterm(8);
    implicant2.addMinterm(9);    Implicant implicant3;
...
TEST(QuineMcCluskeyTest, UnintializedOutputTest)
{
    ...
    EXPECT_EQ(LogicalValue::False, quineMcCluskey.getOutput(0xA));    EXPECT_EQ(LogicalValue::False, quineMcCluskey.getOutput(0x1));
...
{
    QuineMcCluskey quineMcCluskey;
    quineMcCluskey.setInputOutput(0x4, LogicalValue::False);    quineMcCluskey.setInputOutput(0x5, LogicalValue::True);

...
{public:
    ...
    {
        constexpr unsigned int NUMBER_OF_CHILDREN_IN_HEAP_TREE=2U;        HeapTreeAdapter<Values, NUMBER_OF_CHILDREN_IN_HEAP_TREE, std::less> heapTreeAdapter(valuesToSort);

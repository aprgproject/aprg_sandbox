...
public:
    ...
    virtual Object getRoot(Object const& object) const = 0; // this is basically an identifier for the connected components    virtual void connect(Object const& object1, Object const& object2) = 0;
};
...
// -> Union: Join two subsets into a single subset.// In this post, we will discuss the application of Disjoint Set Data Structure.
...
public:
    ...
    Subsets generateOrderedSubsetsUsingDfs(Objects const& objects) const
    {
        Subsets result;
    ...
    Subsets generateSubsetsUsingOnlyRecursion(Objects const& objects) const
    {
        Subsets result;
        Subset currentSubset;
...
private:
    ...
    void collectOrderedSubsetsUsingDfs(Subsets & subsets, Subset & currentSubset, Objects const& objects, unsigned int const index) const
    {
        //DFS like traversal
    ...
    void collectSubsetsUsingOnlyRecursion(Subsets & subsets, Subset & currentSubset, Objects const& objects, unsigned int const index) const
    {

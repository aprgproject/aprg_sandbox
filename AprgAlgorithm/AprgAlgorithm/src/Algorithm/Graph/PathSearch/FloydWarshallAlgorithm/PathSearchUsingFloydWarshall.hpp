...
//        (1)------->(2)
//             3
// Note that the value of graph[i][j] is 0 if i is equal to j// And graph[i][j] is INF (infinite) if there is no edge from vertex i to j.
//
// Output:
// Shortest distance matrix//       0      5      8      9
//     INF      0      3      4
//     INF    INF      0      1
//     INF    INF    INF      0

...
#include <Geometry/TwoDimensions/ConicSectionTypes.hpp>
...
#include <Geometry/TwoDimensions/Polynomial.hpp>
#include <Geometry/TwoDimensions/Quadrants.hpp>
#include <Geometry/TwoDimensions/RotationDirection.hpp>

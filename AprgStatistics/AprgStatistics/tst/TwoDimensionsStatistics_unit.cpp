...
TEST(TwoDimensionsStatisticsTest, SameValuesOfXForLineModeling){
    ...
    samples.emplace_back(LocalSample{5,1});    samples.emplace_back(LocalSample{5,2});
    samples.emplace_back(LocalSample{5,3});
...
TEST(TwoDimensionsStatisticsTest, SameValuesOfYForLineModeling){
    ...
    samples.emplace_back(LocalSample{1,5});    samples.emplace_back(LocalSample{2,5});
...
TEST(TwoDimensionsStatisticsTest, LineModelingWithPositiveSlope){
    ...
    samples.emplace_back(LocalSample{1,1});    samples.emplace_back(LocalSample{2,2});
...
TEST(TwoDimensionsStatisticsTest, LineModelingWithPositiveYIntercept){
    ...
    samples.emplace_back(LocalSample{1,2});    samples.emplace_back(LocalSample{2,3});
...
TEST(TwoDimensionsStatisticsTest, LineModelingWithPositiveXIntercept){
    ...
    samples.emplace_back(LocalSample{2,1});    samples.emplace_back(LocalSample{3,2});
...
TEST(TwoDimensionsStatisticsTest, LineModelingWithScatteredValue){
    ...
    samples.emplace_back(LocalSample{1.50, 53.12});    samples.emplace_back(LocalSample{1.52, 54.48});
...
TEST(TwoDimensionsStatisticsTest, SquareErrorFromLineModelCanBeCalculatedForInvalidLine){
    ...
    EXPECT_EQ(0, TwoDimensionsStatistics::calculateSquareError(LocalSample{5, 3}, lineModel));    EXPECT_EQ(0, TwoDimensionsStatistics::calculateSquareError(LocalSample{7, 5}, lineModel));
}
...
TEST(TwoDimensionsStatisticsTest, SamplesCanBeSortedBySquareErrorFromLineModelForScatteredPoints)
{
    ...
    EXPECT_EQ((LocalSample{1.60, 58.57}), it++->second);    EXPECT_EQ((LocalSample{1.52, 54.48}), it++->second);

...
WRAP_DYNAMIC_ARRAY_MESSAGE(MessageName::TUPC_CM_BEARERS_SETUP_REQ_MSG, SCmBearersSetupReqMsg, SCmBearersSetupReqDynamicPart)
WRAP_DYNAMIC_ARRAY_MESSAGE(MessageName::TUPC_CM_BEARERS_SETUP_RESP_MSG, SCmBearersSetupRespMsg, SCmBearersSetupRespDynamicPart)
WRAP_DYNAMIC_ARRAY_MESSAGE(MessageName::TUPC_CM_BEARERS_RELEASE_REQ_MSG, SCmBearersReleaseReqMsg, SCmBearersReleaseReqDynamicPart)
WRAP_DYNAMIC_ARRAY_MESSAGE(MessageName::TUPC_CM_BEARERS_RELEASE_RESP_MSG, SCmBearersReleaseRespMsg, SCmBearersReleaseRespDynamicPart)
WRAP_DYNAMIC_ARRAY_MESSAGE(MessageName::TUPC_CM_BEARERS_MODIFY_REQ_MSG, SCmBearersModifyReqMsg, SCmBearersModifyReqDynamicPart)
WRAP_STATIC_MESSAGE(MessageName::TUPC_CM_BEARERS_MODIFY_RESP_MSG, SCmBearersModifyRespMsg)
WRAP_DYNAMIC_ARRAY_MESSAGE(MessageName::TUPC_CM_BEARERS_UPDATE_IND_MSG, SCmBearersUpdateIndMsg, SCmBearersUpdateIndDynamicPart)

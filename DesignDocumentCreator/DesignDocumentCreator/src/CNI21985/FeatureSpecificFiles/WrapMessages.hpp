...
WRAP_STATIC_MESSAGE(MessageName::TC_TRANSPORT_BEARER_REALLOCATION_COMMIT_RESP_MSG, STransportBearerReallocationCommitResp)WRAP_STATIC_MESSAGE(MessageName::TC_TRANSPORT_BEARER_REALLOCATION_CLEANUP_REQ_MSG, STransportBearerReallocationCleanupReq)

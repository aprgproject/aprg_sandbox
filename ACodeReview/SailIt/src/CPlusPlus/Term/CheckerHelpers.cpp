...
{
    return TermType::Constant_Boolean == termType ||
            TermType::Constant_Number == termType ||
            TermType::Constant_Character == termType ||
            TermType::Constant_String == termType;
}

bool CheckerHelpers::isConstant(Term const& term)
{
    return isConstant(term.getTermType());
}

bool CheckerHelpers::isIgnorable(TermType const termType)
{
    return TermType::Comment == termType ||
            TermType::MultiLine_Comment == termType ||
            TermType::SingleLine_Comment == termType ||
            TermType::CPlusPlusIgnorableIdentifier == termType;
}

bool CheckerHelpers::isIgnorable(Term const& term)
{
    return isIgnorable(term.getTermType());
}
...
bool CheckerHelpers::isEmpty(TermType const termType)
{
    return TermType::Empty == termType;
}

bool CheckerHelpers::isEmpty(Term const& term)
{
    return isEmpty(term.getTermType());
}
...
bool CheckerHelpers::isNewLine(string const& stringToCheck)
{
    return "\n" == stringToCheck;
}

bool CheckerHelpers::isNewLine(Term const& term)
{
    return TermType::NewLine == term.getTermType();
}
...
bool CheckerHelpers::isProcessed(Term const& term)
{
    return isProcessed(term.getTermType());
}

bool CheckerHelpers::isProcessed(TermType const termType)
{
    return TermType::ProcessedTerm == termType ||
            TermType::MultiLine_IfElseIfStartChain_Ignorable == termType ||
            TermType::Comment == termType ||
            TermType::SingleLine_Comment == termType ||
            TermType::MultiLine_Comment == termType ||
            TermType::CPlusPlusIgnorableIdentifier == termType;
}
...
{
    return TermType::SingleLine_Comment == termType ||
            TermType::MultiLine_Comment == termType;
}
...
{
    return TermType::Type == termType ||
            TermType::Class == termType;
}

bool CheckerHelpers::isValue(TermType const termType)
{
    return isLValue(termType) || isRValue(termType);
}

bool CheckerHelpers::isValue(Term const& term)
{
    return isValue(term.getTermType());
}

bool CheckerHelpers::isWhiteSpace(string const& stringToCheck)
{
    return " " == stringToCheck;
}

bool CheckerHelpers::isWhiteSpace(Term const& term)
{
    return TermType::WhiteSpace == term.getTermType();
}

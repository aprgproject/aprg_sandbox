...
void FindingsBuffer::copyCurrentFindings(Findings& findings)
{
    findings.copyFindings(m_findingsBuffer.back());
}
...
void FindingsBuffer::addFinding(unsigned int const lineNumber, string const& fileLocator, string const& content, string const& locator)
{

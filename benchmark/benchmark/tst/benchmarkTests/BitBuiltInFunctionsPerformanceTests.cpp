...
#define BENCHMARK_FUNCTION(DataType, functionName, name)                                                \
    static void BM_##name(benchmark::State& state) {                                                    \
        AlbaUniformNonDeterministicRandomizer<DataType> randomizer(0, numeric_limits<DataType>::max()); \
        while (state.KeepRunning()) {                                                                   \
            benchmark::DoNotOptimize(functionName(randomizer.getRandomValue()));                        \
            benchmark::ClobberMemory();                                                                 \
        }                                                                                               \
    }                                                                                                   \
    BENCHMARK(BM_##name)
...
BENCHMARK_FUNCTION(
    uint8_t, BitUtilitiesBuiltIn::BitUtilitiesWithoutBuiltIn::isEvenParity, U8_WithoutBuiltin_isEvenParity);
BENCHMARK_FUNCTION(
    uint16_t, BitUtilitiesBuiltIn::BitUtilitiesWithoutBuiltIn::isEvenParity, U16_WithoutBuiltin_isEvenParity);
BENCHMARK_FUNCTION(
    uint32_t, BitUtilitiesBuiltIn::BitUtilitiesWithoutBuiltIn::isEvenParity, U32_WithoutBuiltin_isEvenParity);
BENCHMARK_FUNCTION(
...
BENCHMARK_FUNCTION(
    uint16_t, BitUtilitiesBuiltIn::BitUtilitiesWithoutBuiltIn::getNumberOfOnes, U16_WithoutBuiltin_getNumberOfOnes);
BENCHMARK_FUNCTION(
    uint32_t, BitUtilitiesBuiltIn::BitUtilitiesWithoutBuiltIn::getNumberOfOnes, U32_WithoutBuiltin_getNumberOfOnes);
BENCHMARK_FUNCTION(
    uint64_t, BitUtilitiesBuiltIn::BitUtilitiesWithoutBuiltIn::getNumberOfOnes, U64_WithoutBuiltin_getNumberOfOnes);
BENCHMARK_FUNCTION(
    uint8_t, BitUtilitiesBuiltIn::BitUtilitiesWithBuiltIn::getNumberOfOnes, U8_WithBuiltin_getNumberOfOnes);
BENCHMARK_FUNCTION(
    uint16_t, BitUtilitiesBuiltIn::BitUtilitiesWithBuiltIn::getNumberOfOnes, U16_WithBuiltin_getNumberOfOnes);
BENCHMARK_FUNCTION(
    uint32_t, BitUtilitiesBuiltIn::BitUtilitiesWithBuiltIn::getNumberOfOnes, U32_WithBuiltin_getNumberOfOnes);
BENCHMARK_FUNCTION(
    uint64_t, BitUtilitiesBuiltIn::BitUtilitiesWithBuiltIn::getNumberOfOnes, U64_WithBuiltin_getNumberOfOnes);
...
BENCHMARK_FUNCTION(
    uint16_t, BitUtilitiesBuiltIn::getNumberOfConsecutiveZerosFromMsb, U16_Default_getNumberOfConsecutiveZerosFromMsb);
BENCHMARK_FUNCTION(
    uint32_t, BitUtilitiesBuiltIn::getNumberOfConsecutiveZerosFromMsb, U32_Default_getNumberOfConsecutiveZerosFromMsb);
BENCHMARK_FUNCTION(
    uint64_t, BitUtilitiesBuiltIn::getNumberOfConsecutiveZerosFromMsb, U64_Default_getNumberOfConsecutiveZerosFromMsb);
...
BENCHMARK_FUNCTION(
    uint16_t, BitUtilitiesBuiltIn::getNumberOfConsecutiveZerosFromLsb, U16_Default_getNumberOfConsecutiveZerosFromLsb);
BENCHMARK_FUNCTION(

...
template <typename ElementType>
MathSet<ElementType> getUnion(MathSet<ElementType> const& set1, MathSet<ElementType> const& set2) {
    return set1.getUnionWith(set2);
}

template <typename ElementType>
MathSet<ElementType> getIntersection(MathSet<ElementType> const& set1, MathSet<ElementType> const& set2) {
    return set1.getIntersectionWith(set2);
}

template <typename ElementType>
MathSet<ElementType> getDifference(MathSet<ElementType> const& set1, MathSet<ElementType> const& set2) {
    return set1.getDifferenceWith(set2);
}

template <typename ElementType1, typename ElementType2>
MathSet<std::pair<ElementType1, ElementType2>> getCartersianProduct(
    MathSet<ElementType1> const& set1, MathSet<ElementType2> const& set2,

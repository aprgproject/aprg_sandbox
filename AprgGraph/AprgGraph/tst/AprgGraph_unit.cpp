...
#define APRG_BITMAP_24_BIT_DEFAULT_FILE APRG_DIR R"(AprgGraph\AprgGraph\tst\Bitmaps\Default24Bit.bmp)"
#define APRG_BITMAP_24_BIT_GRAPH_OUTPUT_FILE APRG_DIR R"(AprgGraph\AprgGraph\tst\Bitmaps\GraphOutput.bmp)"

TEST(SampleTest, BitmapGraph24Bits)
{
    AlbaLocalPathHandler defaultFile(APRG_BITMAP_24_BIT_DEFAULT_FILE);
    AlbaLocalPathHandler graphOutputFile(APRG_BITMAP_24_BIT_GRAPH_OUTPUT_FILE);

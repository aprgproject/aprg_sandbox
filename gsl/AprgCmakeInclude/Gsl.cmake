...
if(WIN32)
    ...
    set_property(TARGET GSL PROPERTY IMPORTED_IMPLIB ${GSL_DIR}/lib/gsl2.7/libgsl.a)    add_library(GSLCBLAS SHARED IMPORTED)
    ...
    find_package(GSL REQUIRED)    set (GSL_LIBRARIES_TO_LINK GSL::gsl GSL::gslcblas)
endif()
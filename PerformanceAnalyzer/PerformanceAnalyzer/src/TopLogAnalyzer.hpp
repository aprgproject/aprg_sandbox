...
private:
    ...
    void putHeadersInCpuReport(stringHelper::strings const& processNamesInReport, std::ofstream& cpuReportFileStream) const;
    void putEntriesInCpuReport(stringHelper::strings const& processNamesInReport, std::ofstream& cpuReportFileStream) const;
    void generateMemReport(std::string const& pathOfTopLog);
    stringHelper::strings getProcessNamesForMemReport();
    void putHeadersInMemReport(stringHelper::strings const& processNamesInReport, std::ofstream& cpuReportFileStream) const;
    void putEntriesInMemReport(stringHelper::strings const& processNamesInReport, std::ofstream& cpuReportFileStream) const;

...
private:
    ...
    void saveDspCapacityInformationInGrmOfOneDsp(std::string const& dspCapacityOfOneDsp, unsigned int const boardId, tcomToolsBackend::BtsLogPrint const& logPrint);
    void saveDspCapacityInformationInLrmForR3(std::string const& lineInLogs);
    void saveDspCapacityInformationInLrmOfOneDspForR3(std::string const& dspCapacityOfOneDsp, unsigned int const boardId, tcomToolsBackend::BtsLogPrint const& logPrint);
    void saveDspCapacityInformationInLrmForR2(std::string const& lineInLogs);
    void saveDspCapacityInformationInLrmOfOneDspForR2(std::string const& dspCapacityOfOneDsp, unsigned int const boardId, tcomToolsBackend::BtsLogPrint const& logPrint);
    ...
    void saveTotalUsersAndCfs(tcomToolsBackend::BtsLogPrint const& logPrint);    void saveAllUsersAndCfs(tcomToolsBackend::BtsLogPrint const& logPrint);
    ...
    void setLogTimeIfNeeded(std::string const& lineInLogs, LogTime& logTime) const;    double getTotalMicroseconds(LogTimePair const& logTimePairOfTheUser) const;

...
TEST(QuineMcCluskeyTest, DISABLED_GetInputsFromFromFileWorks_HasZeroInDigitForByte) //
{
    ...
    ImplicantsForTest finalImplicants(quineMcCluskey.getAllFinalImplicants());    EXPECT_EQ("Implicants : [{size: 30 | ' (0)', '1010 (10)', '10100 (20)', '11110 (30)', '-101000 (40, 104, )', '111100 (60)', '1-00110 (70, 102, )',"
              ...
              " '10000010 (130)', '1-001100 (140, 204, )', '10010110 (150)', '10100000 (160)', '10101010 (170)', '10110100 (180)', '10111110 (190)',"              " '11001--- (200, 201, 202, 203, 204, 205, 206, 207, )', '110-1100 (204, 220, )', '1101000- (208, 209, )', '110100-0 (208, 210, )',"
...
TEST(QuineMcCluskeyTest, DISABLED_GetInputsFromFromFile_LogarithmBase2ForByte)
{
    ...
    ImplicantsForTest finalImplicants2(qm2.getAllFinalImplicants());    cout << qm0.getOutputTable(finalImplicants0);
...
TEST(QuineMcCluskeyTest, DISABLED_GetInputsFromFromFile_ZeroesStartingFromMsb)
{
    ...
    ImplicantsForTest finalImplicants0(qm0.getAllFinalImplicants());
    ImplicantsForTest finalImplicants1(qm1.getAllFinalImplicants());    ImplicantsForTest finalImplicants2(qm2.getAllFinalImplicants());

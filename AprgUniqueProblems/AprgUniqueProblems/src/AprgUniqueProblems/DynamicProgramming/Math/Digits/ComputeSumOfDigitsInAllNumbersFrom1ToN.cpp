...
ComputeSumOfDigitsInAllNumbersFrom1ToN::ComputeSumOfDigitsInAllNumbersFrom1ToN(
        Value const lastNumber)
    : m_lastNumber(lastNumber)
{}

ComputeSumOfDigitsInAllNumbersFrom1ToN::Value ComputeSumOfDigitsInAllNumbersFrom1ToN::getValueUsingNaiveSolution() const
{
...
ComputeSumOfDigitsInAllNumbersFrom1ToN::Value ComputeSumOfDigitsInAllNumbersFrom1ToN::getValueUsingMemoizationDP() const
{
    return getValueUsingMemoizationDP(m_lastNumber);
}

ComputeSumOfDigitsInAllNumbersFrom1ToN::Value ComputeSumOfDigitsInAllNumbersFrom1ToN::getValueUsingSummationValues() const
{
    ...
    for(Value numberForDigitsSum=m_lastNumber; numberForDigitsSum>0; numberForDigitsSum/=10, digitIndex++, previousPowerOf10=powerOf10, powerOf10*=10)
    {
        ...
        Value const number) const
{
    ...
    else
    {
        ...
        {
            sumAtDigitIndex[digitIndex] = 10*sumAtDigitIndex.at(digitIndex-1) + 45*getRaiseToPowerForIntegers(10U, digitIndex-1);
        }
        ...
        result = mostSignificantDigit * sumAtDigitIndex.at(numberOfDigitsMinus1)
                ...
                + mostSignificantDigit * (1+remainingDigits)
                + getValueUsingMemoizationDP(remainingDigits);
    }
    return result;
}

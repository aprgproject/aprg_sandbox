...
MobileNumericKeypadProblem::MobileNumericKeypadProblem(Count const length) : m_length(length) {}
...
MobileNumericKeypadProblem::Count MobileNumericKeypadProblem::getCountUsingIterativeDP() const {
    ...
    if (m_length > 0) {
        ...
        for (Count lengthMinus1 = 1; lengthMinus1 < m_length; lengthMinus1++) {
            ...
            countMatrix.setEntry(
                lengthMinus1, 1,
                countMatrix.getEntry(previousLengthMinus1, 1) + countMatrix.getEntry(previousLengthMinus1, 2) +
                    countMatrix.getEntry(previousLengthMinus1, 4));
            countMatrix.setEntry(
                lengthMinus1, 2,
                countMatrix.getEntry(previousLengthMinus1, 2) + countMatrix.getEntry(previousLengthMinus1, 1) +
                    countMatrix.getEntry(previousLengthMinus1, 3) + countMatrix.getEntry(previousLengthMinus1, 5));
            countMatrix.setEntry(
                lengthMinus1, 3,
                countMatrix.getEntry(previousLengthMinus1, 3) + countMatrix.getEntry(previousLengthMinus1, 2) +
                    countMatrix.getEntry(previousLengthMinus1, 6));
            countMatrix.setEntry(
                lengthMinus1, 4,
                countMatrix.getEntry(previousLengthMinus1, 4) + countMatrix.getEntry(previousLengthMinus1, 1) +
                    countMatrix.getEntry(previousLengthMinus1, 5) + countMatrix.getEntry(previousLengthMinus1, 7));
            countMatrix.setEntry(
                lengthMinus1, 5,
                countMatrix.getEntry(previousLengthMinus1, 5) + countMatrix.getEntry(previousLengthMinus1, 2) +
                    countMatrix.getEntry(previousLengthMinus1, 4) + countMatrix.getEntry(previousLengthMinus1, 6) +
                    countMatrix.getEntry(previousLengthMinus1, 8));
            countMatrix.setEntry(
                lengthMinus1, 6,
                countMatrix.getEntry(previousLengthMinus1, 6) + countMatrix.getEntry(previousLengthMinus1, 3) +
                    countMatrix.getEntry(previousLengthMinus1, 5) + countMatrix.getEntry(previousLengthMinus1, 6));
            countMatrix.setEntry(
                lengthMinus1, 7,
                countMatrix.getEntry(previousLengthMinus1, 7) + countMatrix.getEntry(previousLengthMinus1, 4) +
                    countMatrix.getEntry(previousLengthMinus1, 8));
            countMatrix.setEntry(
                lengthMinus1, 8,
                countMatrix.getEntry(previousLengthMinus1, 8) + countMatrix.getEntry(previousLengthMinus1, 5) +
                    countMatrix.getEntry(previousLengthMinus1, 7) + countMatrix.getEntry(previousLengthMinus1, 9) +
                    countMatrix.getEntry(previousLengthMinus1, 0));
            countMatrix.setEntry(
                lengthMinus1, 9,

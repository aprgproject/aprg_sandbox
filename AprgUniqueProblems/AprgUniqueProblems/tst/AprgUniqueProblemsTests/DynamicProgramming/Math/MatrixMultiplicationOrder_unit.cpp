...
TEST(MatrixMultiplicationOrderTest, GetMinimumNumberOfOperationsWorksOnExample2)
{
    ...
    EXPECT_EQ(30000U, queryForTest.getMinimumNumberOfOperationsUsingNaiveRecursion());    EXPECT_EQ(30000U, queryForTest.getMinimumNumberOfOperationsUsingMemoizationDP());
...
TEST(MatrixMultiplicationOrderTest, GetMinimumNumberOfOperationsWorksOnExample3)
{
    ...
    EXPECT_EQ(6000U, queryForTest.getMinimumNumberOfOperationsUsingNaiveRecursion());    EXPECT_EQ(6000U, queryForTest.getMinimumNumberOfOperationsUsingMemoizationDP());

...
TEST(MaximizeProfitInZeroOneKnapsackTest, GetBestProfitWorksOnExample1) {
    ...
    EXPECT_EQ(220, queryForTest.getBestProfitUsingMemoizationDP());    EXPECT_EQ(220, queryForTest.getBestProfitUsingIterativeDP());
...
TEST(MaximizeProfitInZeroOneKnapsackTest, GetBestProfitWorksOnExample2) {
    ...
    EXPECT_EQ(22, queryForTest.getBestProfitUsingNaiveRecursion());    EXPECT_EQ(22, queryForTest.getBestProfitUsingMemoizationDP());

...
TEST(IsPartialSumPossibleInZeroOneKnapsackTest, GetBestProfitWorksOnExample1) {
    ...
    EXPECT_TRUE(queryForTest.isPartialSumPossibleUsingMemoizationDP());    EXPECT_TRUE(queryForTest.isPartialSumPossibleUsingIterativeDP());
...
TEST(IsPartialSumPossibleInZeroOneKnapsackTest, GetBestProfitWorksOnExample2) {
    ...
    EXPECT_FALSE(queryForTest.isPartialSumPossibleUsingMemoizationDP());    EXPECT_FALSE(queryForTest.isPartialSumPossibleUsingIterativeDP());

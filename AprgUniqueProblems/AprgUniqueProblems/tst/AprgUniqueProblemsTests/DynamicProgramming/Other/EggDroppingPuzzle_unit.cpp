...
TEST(EggDroppingPuzzleTest, GetMinimumNumberOfOperationsWorksOnExample2)
{
    ...
    EXPECT_EQ(5U, queryForTest.getMinimumNumberOfTrialsUsingNaiveRecursion());    EXPECT_EQ(5U, queryForTest.getMinimumNumberOfTrialsUsingMemoizationDP());
...
TEST(EggDroppingPuzzleTest, GetMinimumNumberOfOperationsWorksOnExample3)
{
    ...
    EXPECT_EQ(4U, queryForTest.getMinimumNumberOfTrialsUsingNaiveRecursion());    EXPECT_EQ(4U, queryForTest.getMinimumNumberOfTrialsUsingMemoizationDP());
...
TEST(EggDroppingPuzzleTest, GetMinimumNumberOfOperationsWorksOnExample4)
{
    ...
    //EXPECT_EQ(8U, queryForTest.getMinimumNumberOfTrialsUsingNaiveRecursion()); // too long    EXPECT_EQ(8U, queryForTest.getMinimumNumberOfTrialsUsingMemoizationDP());

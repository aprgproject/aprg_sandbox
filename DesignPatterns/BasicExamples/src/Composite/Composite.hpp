...
public:
    ...
    virtual Component const* getChildPointerAt(unsigned int const) const  // Make sure that this doesn't break interface segregation principle. (Make sure the method/function makes sense.)
    {
        return nullptr;
    }

    virtual void add(std::unique_ptr<Component>) // Make sure that this doesn't break interface segregation principle. (Make sure the method/function makes sense.)
    {
        //...
    }

    virtual void removeAtIndex(unsigned int const) // Make sure that this doesn't break interface segregation principle. (Make sure the method/function makes sense.)
    {
        //...
    }
...
{
public:
    Component const* getChildPointerAt(unsigned int const index) const override
    {
    ...
    void removeAtIndex(unsigned int const index) override
    {
...
{
public:
    Leaf(unsigned int const id)
        : m_id(id)
    {}

    void operation() override
    {
        std::cout << "Leaf "<< m_id <<" operation\n";
    }

...
// -> you have a proliferation of classes (class explosion), and responsibilities needs to extracted// -> you want to share an implementation among multiple objects (and it needs to be hidden from the client)

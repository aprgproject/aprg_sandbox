...
// ---> A mediator replaces many-to-many interactions with one-to-many interactions between the mediator and its
// colleagues.
// ---> One-to-many relationships are easier to understand, maintain, and extend.
// -> It abstracts how objects cooperate.
// ---> Making mediation an independent concept and encapsulating in an object lets you focus on how objects interact
// apart from their individual behavior.
...
// ---> The abstract coupling the Meditator class provide lets colleagues work with different Mediator subclasses and
// vice versa.
...
// ---> In concrast, Mediator enables cooperative behavior that colleague objects don't or can't provide, and the
